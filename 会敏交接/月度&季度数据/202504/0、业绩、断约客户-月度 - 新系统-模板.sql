...
from
	(
	 ...
	 where 
		sdt  between '20230101' and '20250430'
...
from
	(
	 ...
	 where 
	 -- 判断取三个季度
		sdt between '20240101' and '20250331'
		and business_type_code in ('1') 
		and channel_code in('1','7','9')
...
where after_month >= '202501'	-- 判断取当前季度
...
from
	(
	 ...
	 from 
		csx_dws.csx_dws_sale_detail_di 
	 where 
		sdt  between '20200101' and '20250430'
		and business_type_code in ('1') 
		and channel_code in('1','7','9')
