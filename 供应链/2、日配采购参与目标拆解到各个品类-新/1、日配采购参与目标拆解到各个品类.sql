...
select '合肥市' as city_name,11987108.43 as sale_amt_target,2277550.6 as profit_target 
union all select '阜阳市' as city_name,2253855.05 as sale_amt_target,439501.73 as profit_target 
union all select '台州市' as city_name,2129513.03 as sale_amt_target,321556.47 as profit_target 
union all select '杭州市' as city_name,5616948.36 as sale_amt_target,1033518.5 as profit_target 
union all select '宁波市' as city_name,2928000 as sale_amt_target,611219.98 as profit_target 
union all select '武汉市' as city_name,2137531.62 as sale_amt_target,288566.77 as profit_target 
union all select '江苏盐城' as city_name,765180.66 as sale_amt_target,120898.54 as profit_target 
union all select '南京主城' as city_name,13600000 as sale_amt_target,2828800 as profit_target 
union all select '上海松江' as city_name,8322818.58 as sale_amt_target,1647918.08 as profit_target 
union all select '江苏苏州' as city_name,10012497.33 as sale_amt_target,1401749.63 as profit_target 
union all select '南昌市' as city_name,2497562.26 as sale_amt_target,319687.97 as profit_target 
union all select '泉州市' as city_name,4976031.56 as sale_amt_target,995206.31 as profit_target 
union all select '莆田市' as city_name,5540101.85 as sale_amt_target,997218.33 as profit_target 
union all select '龙岩市' as city_name,1756473.7 as sale_amt_target,242393.37 as profit_target 
union all select '宁德市' as city_name,1103460 as sale_amt_target,-12200 as profit_target 
union all select '三明市' as city_name,3038255.28 as sale_amt_target,470929.57 as profit_target 
union all select '南平市' as city_name,5267732.34 as sale_amt_target,632127.88 as profit_target 
union all select '厦门市' as city_name,5444578.35 as sale_amt_target,1121583.14 as profit_target 
union all select '福州市' as city_name,29230255.78 as sale_amt_target,5846051.16 as profit_target 
union all select '深圳市' as city_name,20175547.2 as sale_amt_target,3006156.53 as profit_target 
union all select '广东广州' as city_name,7389000 as sale_amt_target,1256130 as profit_target 
union all select '贵阳市' as city_name,6560820 as sale_amt_target,1523847.59 as profit_target 
union all select '成都市' as city_name,22122533.12 as sale_amt_target,4714390.06 as profit_target 
union all select '宜宾' as city_name,2328852.51 as sale_amt_target,372616.4 as profit_target 
union all select '重庆主城' as city_name,42462150 as sale_amt_target,8266054.59 as profit_target 
union all select '黔江区' as city_name,2408373.58 as sale_amt_target,505758.45 as profit_target 
union all select '万州区' as city_name,1511283.88 as sale_amt_target,367241.98 as profit_target 
union all select '北京市' as city_name,48143574.77 as sale_amt_target,9869432.83 as profit_target 
union all select '郑州市' as city_name,14311401.61 as sale_amt_target,2060841.83 as profit_target 
union all select '西安市' as city_name,13832056.56 as sale_amt_target,1921360 as profit_target 
union all select '石家庄市' as city_name,17032100 as sale_amt_target,2725136 as profit_target 
union all select '哈尔滨市' as city_name,6982500 as sale_amt_target,1245838.76 as profit_target 
union all select '大连' as city_name,6158835.12 as sale_amt_target,856078.08 as profit_target 
;
