...
from
	( 
	select
		sdt,customer_code,order_code,goods_code,sale_amt,profit,performance_region_name,performance_province_name,performance_city_name,refund_order_flag
	from
	...
	(select
		...
		first_level_reason_code -- 一级退货原因编码
