...
(select inventory_dc_code,goods_code,
goods_name,
...
left join 
(select goods_code,goods_name,goods_status_name
from csx_dim.csx_dim_basic_dc_goods 
where sdt='current' 
and dc_code='W0A3') b on a.goods_code=b.goods_code
left join 
(select goods_code	,
    goods_name,
    classify_large_name,
...
left join 
tmp_csx_dwd_price_effective_purchase_prices_di d on a.goods_code=d.product_code