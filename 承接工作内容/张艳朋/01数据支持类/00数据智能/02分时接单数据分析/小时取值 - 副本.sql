...
(
  ...
  (
    ...
    where (sdt >= '20200701' or sdt = '19990101') and refund_no is null
      ...
      and if(recep_order_time like '1999%', created_time, recep_order_time) < '2020-09-01'
  ...
  (
    select
      customer_no, sales_province, sales_city,first_category,second_category,third_category
    from csx_dw.dws_crm_w_a_customer_m_v1 
    where sdt = 'current'
  ) b on a.customer_no = b.customer_no
) t1 group by t1.order_no_header, t1.sales_province, t1.sales_city,t1.first_category,t1.second_category;
