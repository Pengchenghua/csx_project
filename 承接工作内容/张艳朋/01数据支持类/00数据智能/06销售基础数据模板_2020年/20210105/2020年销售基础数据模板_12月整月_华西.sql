...
insert overwrite directory '/tmp/zhangyanpeng/sales_base_b_1_20210105' row format delimited fields terminated by '\t' 
...
insert overwrite directory '/tmp/zhangyanpeng/sales_base_new_sign_20210105' row format delimited fields terminated by '\t' 
...
where
	c.region_name='华西大区'
	and b.sign_time between '20201201' and '20201231'
...
insert overwrite directory '/tmp/zhangyanpeng/sales_base_new_deal_20210105' row format delimited fields terminated by '\t' 
...
from
	...
	left join
		...
		where 
			sdt = '20201231' --可取最新分区
			and first_order_date between '20201201' and '20201231'
		group by
			customer_no,first_order_date	
		) d on a.customer_no=d.customer_no
where
