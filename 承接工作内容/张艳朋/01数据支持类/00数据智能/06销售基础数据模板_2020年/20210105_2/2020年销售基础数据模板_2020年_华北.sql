...
insert overwrite directory '/tmp/zhangyanpeng/sales_base_b_huabei_20210105' row format delimited fields terminated by '\t' 
...
insert overwrite directory '/tmp/zhangyanpeng/sales_base_m_huabei_20210105' row format delimited fields terminated by '\t' 
...
insert overwrite directory '/tmp/zhangyanpeng/sales_base_new_sign_huabei_20210105' row format delimited fields terminated by '\t' 
...
insert overwrite directory '/tmp/zhangyanpeng/sales_base_new_deal_huabei_20210105' row format delimited fields terminated by '\t' 
