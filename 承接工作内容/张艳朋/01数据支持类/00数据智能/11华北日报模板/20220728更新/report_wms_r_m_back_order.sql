...
-- 目标表
set target_table=csx_dw.report_wms_r_m_back_order;
...
select
    concat_ws('-',region_code,province_code,business_flag,substr(${hiveconf:current_day}, 1, 6)) as biz_id,
	region_code,
	region_name,
	province_code,
	province_name,
...
INVALIDATE METADATA csx_dw.report_wms_r_m_back_order;	



/*
--------------------------------- hive建表语句 -------------------------------
-- csx_dw.report_wms_r_m_back_order  华北日报 回单统计

drop table if exists csx_dw.report_wms_r_m_back_order;
create table csx_dw.report_wms_r_m_back_order(
...
--alter table csx_dw.report_wms_r_m_back_order add columns(
--	city_group_code string comment '城市组编码',
--	city_group_name string comment '城市组名称');
	
--ALTER TABLE csx_dw.report_wms_r_m_back_order CHANGE city_group_code city_group_code STRING COMMENT '城市组编码' AFTER province_name;
--ALTER TABLE csx_dw.report_wms_r_m_back_order CHANGE city_group_name city_group_name STRING COMMENT '城市组名称' AFTER city_group_code;
