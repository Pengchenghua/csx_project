...
-- 切换tez计算引擎
set mapred.job.name=report_sale_r_d_business_rank_service_manager;
...
-- 目标表
set target_table=csx_tmp.report_sale_r_d_business_rank_service_manager;
...
INVALIDATE METADATA csx_tmp.report_sale_r_d_business_rank_service_manager;	



/*
--------------------------------- hive建表语句 -------------------------------
-- csx_tmp.report_sale_r_d_business_rank_service_manager  销售员指标

drop table if exists csx_tmp.report_sale_r_d_business_rank_service_manager;
create table csx_tmp.report_sale_r_d_business_rank_service_manager(
