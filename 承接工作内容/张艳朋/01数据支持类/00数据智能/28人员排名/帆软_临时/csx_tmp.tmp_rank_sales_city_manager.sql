...
-- 切换tez计算引擎
set mapred.job.name=tmp_r_m_rank_sales_city_manager;
...
-- 目标表
set target_table=csx_tmp.tmp_r_m_rank_sales_city_manager;
	
with current_tmp_r_m_rank_sales_city_manager as 	
(
select
	b.province_code,
	b.province_name,
...
from
	current_tmp_r_m_rank_sales_city_manager
;



INVALIDATE METADATA csx_tmp.tmp_r_m_rank_sales_city_manager;	



/*
--------------------------------- hive建表语句 -------------------------------
-- csx_tmp.tmp_r_m_rank_sales_city_manager  销售员指标

drop table if exists csx_tmp.tmp_r_m_rank_sales_city_manager;
create table csx_tmp.tmp_r_m_rank_sales_city_manager(
