...
drop table if exists csx_tmp.pandian_post_no_20200920; 
create temporary table csx_tmp.pandian_post_no_20200920
as
select
	b.province_name,   --省区
	b.city_name,   --城市
...
select * from csx_tmp.pandian_post_no_20200920; 
