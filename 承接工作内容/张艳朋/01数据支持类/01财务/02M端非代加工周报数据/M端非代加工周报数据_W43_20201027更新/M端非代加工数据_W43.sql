--==============================================================================================================
--月累计
insert overwrite directory '/tmp/zhangyanpeng/m' row format delimited fields terminated by '\t' 
...
from	
	...
	where 
		(sdt between '20201001' and '20201025' or sdt between '20200901' and '20200925')
...
insert overwrite directory '/tmp/zhangyanpeng/m_w' row format delimited fields terminated by '\t' 					
...
from	
	...
	from 
		csx_dw.dws_sale_r_d_customer_sale
	where 
		sdt between '20201010' and '20201023'
		and channel = '2' --1-大客户 2-商超 4-大宗 5-供应链（食百） 6-供应链（生鲜） 7-企业购 9-业务代理
		and (dc_code not in ('W0R1','W0T6','W0M4','W0T3','W0T7','W0M6','W0S8','W0X4','W0T5') or (dc_code in ('W0M4') and department_code not in ('H03','H01')))--数据不含代加工DC 
