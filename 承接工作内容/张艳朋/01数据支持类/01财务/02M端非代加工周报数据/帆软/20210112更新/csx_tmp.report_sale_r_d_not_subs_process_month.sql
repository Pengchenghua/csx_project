...
insert overwrite table csx_tmp.report_sale_r_d_not_subs_process_month partition(sdt)
...
select
	...
	${hiveconf:i_sdate_11} as update_time,
...
INVALIDATE METADATA csx_tmp.report_sale_r_d_not_subs_process_month;


/*
--------------------------------- hive建表语句 -------------------------------
-- csx_tmp.report_sale_r_d_not_subs_process_month  M端非代加工月环比数据

drop table if exists csx_tmp.report_sale_r_d_not_subs_process_month;
create table csx_tmp.report_sale_r_d_not_subs_process_month(
