...
insert overwrite directory '/tmp/zhangyanpeng/20210819_02_01' row format delimited fields terminated by '\t' 
--结果表  
...
insert overwrite directory '/tmp/zhangyanpeng/20210819_02_02' row format delimited fields terminated by '\t' 
--结果表  
--判断各月新客，计算每月新客在之后各月是否有销售
select
	sales_region_name,
...
insert overwrite directory '/tmp/zhangyanpeng/20210819_02_03' row format delimited fields terminated by '\t' 
--结果表  
--判断各月新客，计算每月新客在之后各月是否有销售
select
	sales_region_name,
...
insert overwrite directory '/tmp/zhangyanpeng/20210819_03_01' row format delimited fields terminated by '\t' 
