...
insert overwrite directory '/tmp/zhangyanpeng/20220315_01_05' row format delimited fields terminated by '\t'   
...
insert overwrite directory '/tmp/zhangyanpeng/20220315_01_06' row format delimited fields terminated by '\t' 
--结果表  
--判断各月新客，计算每月新客在之后各月是否有销售
select 
	c.sales_province_name,
