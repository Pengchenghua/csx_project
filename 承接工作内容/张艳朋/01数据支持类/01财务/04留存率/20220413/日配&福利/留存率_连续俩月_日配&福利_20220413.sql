-- ====================================================================================================================================================
--连续两个月履约日配或福利业务
drop table if exists csx_tmp.tmp_ripei_fuli_lianxu_months;
create table csx_tmp.tmp_ripei_fuli_lianxu_months
as
select
...
insert overwrite directory '/tmp/zhangyanpeng/20220413_01_04' row format delimited fields terminated by '\t' 
--结果表  
...
from
	...
	from
		csx_tmp.tmp_ripei_fuli_lianxu_months
	where 
