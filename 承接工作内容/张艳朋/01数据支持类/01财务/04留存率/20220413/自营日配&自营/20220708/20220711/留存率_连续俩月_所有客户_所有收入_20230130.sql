...
--=============================================================================================================================================================================
drop table if exists csx_analyse_tmp.csx_analyse_tmp_ripei_liucun_20230113_04;
create table csx_analyse_tmp.csx_analyse_tmp_ripei_liucun_20230113_04
as
select 
...
;
select * from csx_analyse_tmp.csx_analyse_tmp_ripei_liucun_20230113_04

--====================================================================================================================================================================
drop table if exists csx_analyse_tmp.csx_analyse_tmp_ripei_liucun_20230113_05;
create table csx_analyse_tmp.csx_analyse_tmp_ripei_liucun_20230113_05
as
select 
	c.performance_province_name,
	a.customer_code,
...
from
	...
	join
		(
		select 
			customer_code,substr(max(sdt),1,6) as last_order_month
		from 
			-- csx_dw.dws_sale_r_d_detail
			csx_dws.csx_dws_sale_detail_di
		where 
...
select * from csx_analyse_tmp.csx_analyse_tmp_ripei_liucun_20230113_05
