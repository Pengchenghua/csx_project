...
create table csx_analyse_tmp.csx_analyse_tmp_ripei_liucun_20230113_03
as
select 
	...
	count(distinct if(a.new_smonth<=e.max_smonth,a.customer_code,b.customer_code)) counts,
...
from
	...
	left join
		(
		select 
			customer_code,max(substr(sdt,1,6)) as max_smonth
		from 
			-- csx_dw.dws_sale_r_d_detail
			csx_dws.csx_dws_sale_detail_di
		where 
...
;	
select * from csx_analyse_tmp.csx_analyse_tmp_ripei_liucun_20230113_03