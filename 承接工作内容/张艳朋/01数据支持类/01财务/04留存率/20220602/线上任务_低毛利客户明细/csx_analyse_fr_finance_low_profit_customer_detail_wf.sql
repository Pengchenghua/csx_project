with tmp_low_profit_customer_detail as
(
select 
	* 
from 
...
insert overwrite table csx_analyse.csx_analyse_fr_finance_low_profit_customer_detail_wf
...
from
	...
	from 
		tmp_low_profit_customer_detail
	where 
		(business_type_code=1 and order_channel_code not in(4,6)) 
		or business_type_code in (2,6)
	group by 
		customer_code
	)a
	join
