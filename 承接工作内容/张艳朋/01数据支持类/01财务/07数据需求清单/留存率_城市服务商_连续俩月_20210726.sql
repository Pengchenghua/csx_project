...
insert overwrite directory '/tmp/zhangyanpeng/20210726_linshi_3' row format delimited fields terminated by '\t' 
--结果表  
...
insert overwrite directory '/tmp/zhangyanpeng/20210726_linshi_4' row format delimited fields terminated by '\t' 
--结果表  
--判断各月新客，计算每月新客在之后各月是否有销售
select 
	c.sales_province_name,
