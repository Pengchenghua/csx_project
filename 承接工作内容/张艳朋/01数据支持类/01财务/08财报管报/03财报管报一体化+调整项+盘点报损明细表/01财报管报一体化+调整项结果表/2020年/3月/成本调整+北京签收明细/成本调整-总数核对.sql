...
where create_time>='2020-03-01'
and create_time<'2020-04-01';

--成本端发货维度数据关系调整单 - 按原单凭证号和商品汇总
select count(concat(credential_no,product_code)),count(distinct concat(credential_no,product_code))
from csx_ods.source_sync_r_d_data_relation_cas_sale_adjustment
where posting_time >= '2020-03-01 00:00:00' 
...
data_relation_cas_sale_adjustment---------------------csx_ods.source_sync_r_d_data_relation_cas_sale_adjustment
...
and a.posting_time < '2020-04-01 00:00:00';
...
and attribution_date < '2020-04-01'
group by cost_name;
...
and commit_time<'2020-04-01 00:00:00'
