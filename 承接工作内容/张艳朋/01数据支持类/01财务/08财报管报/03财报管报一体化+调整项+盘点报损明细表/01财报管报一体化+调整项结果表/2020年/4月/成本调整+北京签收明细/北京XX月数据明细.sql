...
--data_sync_sale_order --csx_ods.source_sync_r_d_data_sync_sale_order  wangwei
--19990101 分区 
...
as
select
 b.province_code,b.province_name,d.channel,e.sales_belong_flag,c.received_cust_code,c.sale_cust_name,
