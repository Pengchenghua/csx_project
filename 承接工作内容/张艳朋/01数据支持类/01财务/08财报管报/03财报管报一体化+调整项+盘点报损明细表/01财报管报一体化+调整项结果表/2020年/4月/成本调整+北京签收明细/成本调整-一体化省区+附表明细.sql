...
and  posting_time < '2020-05-01 00:00:00') a
left join 
...
and a.posting_time < '2020-05-01 00:00:00')a
left join 
(select if(shop_id like '9%',concat('E',substr(shop_id,2,3)),shop_id)shop_id,shop_name,province_name
from csx_dw.shop_m where sdt = 'current') b on b.shop_id=a.location_code
group by case when a.location_code='W0H4' then '供应链' else b.province_name end;
...
and attribution_date < '2020-05-01' )a
...
and commit_time<'2020-05-01 00:00:00')a
left join 
(select if(shop_id like '9%',concat('E',substr(shop_id,2,3)),shop_id)shop_id,shop_name,province_name
...
goods_id,department_id,department_name
	from csx_dw.goods_m where sdt = 'current' )b on a.product_code=b.goods_id
group by a.province_name,b.department_id,b.department_name;
...
--6、附表9 盘盈 盘亏 amt_no_tax,amt 到商品课组
...
from csx_dw.shop_m where sdt = 'current') b on b.shop_id=a.inventory_dc_code
where a.type in ('0','1')
and a.commit_time>='2020-04-01 00:00:00'
and a.commit_time<'2020-05-01 00:00:00')a
