...
where sdt = '19990101'
and posting_time >= '2020-08-01 00:00:00' 
and  posting_time < '2020-09-01 00:00:00';
...
and a.posting_time >= '2020-08-01 00:00:00' 
and a.posting_time < '2020-09-01 00:00:00';
...
where sdt='19990101'
and attribution_date >= '2020-08-01' 
and attribution_date < '2020-09-01'
group by cost_name;
...
where type in ('0','1')
and commit_time>='2020-08-01 00:00:00'
and commit_time<'2020-09-01 00:00:00'
