...
select 
  ...
  t2.customer_name,
  t2.attribute_code,
  if(t2.is_new_sign = 1,'是', '否')  as is_new_sign,
  if(t2.is_new_order = 1,'是', '否') as is_new_sale,
  t1.sales_value,
  t1.sales_cost,
  t1.profit,
  t1.no_tax_sales,
  ...
  t1.no_tax_profit,
  t1.sdt
from last_sale_order t1 left outer join last_active_customer t2 on t1.customer_no = t2.customer_no and t1.sdt = t2.sdt;