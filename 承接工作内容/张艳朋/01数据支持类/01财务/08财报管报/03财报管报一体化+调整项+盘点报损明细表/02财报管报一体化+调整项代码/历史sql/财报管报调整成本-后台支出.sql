...
select 
	...
	c.channel,a.goods_code as product_code,a.goods_name as product_name,e.dept_id,e.dept_name,
...
c.channel,a.goods_code,a.goods_name,e.dept_id,e.dept_name,
...
select adjust_reason,dc_code as inventory_dc_code,dc_name as inventory_dc_name,
	...
	channel,product_code,product_name,dept_id,dept_name,is_factory_goods_name,
	amt_no_tax,amt,
