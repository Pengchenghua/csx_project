...
-- 本月第一天，上月第一天，上上月第一天
set i_sdate_11 ='2020-06-01';
set i_sdate_12 ='2020-05-01';
set i_sdate_13 ='2020-04-01';

-- 本月第一天，上月第一天，上上月第一天
set i_sdate_21 ='20200601';
set i_sdate_22 ='20200501';
set i_sdate_23 ='20200401';
...
from
	...
	from 
		...
		from csx_dw.dwd_sync_r_d_data_inventory_detail a
		where a.sdt >= ${hiveconf:i_sdate_22}
		and a.sdt <${hiveconf:i_sdate_21}
		...
		--and a.posting_time < ${hiveconf:i_sdate_11} 
		) a 
	left join 
