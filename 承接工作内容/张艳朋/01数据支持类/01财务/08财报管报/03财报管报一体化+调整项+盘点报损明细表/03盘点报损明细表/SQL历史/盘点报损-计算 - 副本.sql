--  自动同步近2月过账时间数据，无需单独同步
-- 无需等关账，月初同步两张表csx_tmp.source_cas_r_d_accounting_credential_header，csx_tmp.source_cas_r_d_accounting_credential_item
...
-- 本月第一天，上月第一天，上上月第一天
set i_sdate_11 ='2020-07-01';
set i_sdate_12 ='2020-06-01';
set i_sdate_13 ='2020-05-01';

-- 本月第一天，上月第一天，上上月第一天
set i_sdate_21 ='20200701';
set i_sdate_22 ='20200601';
set i_sdate_23 ='20200501';
...
from
	(
	select * from csx_tmp.source_cas_r_d_accounting_credential_item 
	where sdt='19990101' 
...
left join (select * from csx_tmp.source_cas_r_d_accounting_credential_header where sdt='19990101')header on a.credential_no=header.credential_no
