...
drop table csx_tmp.cbgb_tz_m_cbgb_pd_djg;
create table csx_tmp.cbgb_tz_m_cbgb_pd_djg
as 
select 
	...
	cast(inventory_p_no as decimal(21,6)) as inventory_p_no,
	cast(inventory_l_no as decimal(21,6)) as inventory_l_no,
	cast(inventory_p as decimal(21,6)) as inventory_p,
	cast(inventory_l as decimal(21,6)) as inventory_l,
