...
from
	...
	left join(select * from csx_ods.csx_ods_csx_b2b_wms_wms_reservoir_area_df where sdt='20221107'
...
where
	to_date(belong_date) >= '2022-10-01'
	and to_date(belong_date) <= '2022-10-31'
	-- sdt>='20221001' and sdt<='20221031'
;
...
from
	...
	join(select distinct order_code from csx_dws.csx_dws_sale_detail_di where sdt>='20221001' and sdt<='20221031') b on b.order_code=a.no_type
