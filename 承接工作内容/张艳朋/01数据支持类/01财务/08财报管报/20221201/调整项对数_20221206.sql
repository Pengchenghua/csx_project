...
from
	...
	left join(select * from csx_ods.csx_ods_csx_b2b_wms_wms_reservoir_area_df where sdt='20221205'
...
where
	to_date(belong_date) >= '2022-11-01'
	and to_date(belong_date) <= '2022-11-30'
...
from
	...
	join(select distinct order_code from csx_dws.csx_dws_sale_detail_di where sdt>='20221101' and sdt<='20221130') b on b.order_code=a.no_type
