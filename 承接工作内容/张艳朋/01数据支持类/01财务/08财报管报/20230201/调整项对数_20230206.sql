...
from
	...
	left join(select * from csx_ods.csx_ods_csx_b2b_wms_wms_reservoir_area_df where sdt='20230205'
...
where
	to_date(belong_date) >= '2023-01-01'
	and to_date(belong_date) <= '2023-01-31'
...
from
	...
	join(select distinct order_code from csx_dws.csx_dws_sale_detail_di where sdt>='20230101' and sdt<='20230131') b on b.order_code=a.no_type
