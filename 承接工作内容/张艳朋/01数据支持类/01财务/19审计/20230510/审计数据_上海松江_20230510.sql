...
as
select
	'20221001-20230430' as qijian,a.performance_province_name,a.order_code,a.order_sale_date,
...
as
select
	'20221001-20230430' as qijian,a.performance_province_name,a.order_code,a.order_sale_date,a.order_sale_amt,
	a.order_sale_amt/a.order_sale_qty as order_sale_price,
	...
	from
		...
		left join
			...
			from
				csx_analyse_tmp.csx_analyse_tmp_finance_shenji_sale_detail
			where 
				sdt>='20211001' and sdt<='20230430' -- 多往前追1年
				and channel_code in('1','7','9') -- 渠道编码(1.大客户 2.商超 4.大宗 5.供应链(食百) 6.供应链(生鲜) 8.其他 9.业务代理)
...
from
	...
	where
		sdt>='20200101'
		and audit_status_code='1' -- 审核状态编码:(0:待审核 1:审核通过 2:审核拒绝)
		and to_date(rebate_time) between '2022-10-01' and '2023-04-30'
...
from
	...
	join
		...
		where
			sdt='current'
			and performance_province_name in('上海松江','江苏苏州','江苏南京')
		) b on b.customer_code=a.customer_code	
;
