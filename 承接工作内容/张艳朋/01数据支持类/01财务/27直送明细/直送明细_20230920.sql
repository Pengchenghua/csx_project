...
from
	(
	select 
		a.sdt,a.performance_province_name,a.inventory_dc_code,a.classify_middle_name,
		...
		if(d.shop_code is null,'否','是') types,business_type_name
	from 
		(
		select
	...
	group by 
		...
		if(d.shop_code is null,'否','是'),business_type_name
	) a 
;
