...
-- 开始日期
set current_start_day = '20220415';

-- 结束日期
set current_end_day = '20220715';
...
select
	...
	sum(case when a.sdt>='20220701' and a.sdt<='20220724' then a.sales_value else 0 end) as last_month_sales_value,
	count(distinct case when a.sdt>='20220701' and a.sdt<='20220724' then a.customer_no else null end) as last_month_customer_cnt
from 
	(
	select 
