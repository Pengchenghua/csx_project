...
select
	...
	-- 
	sum(case when a.sdt between '20230524' and '20230624' then a.sale_amt end) sale_amt,
	sum(case when a.sdt between '20230524' and '20230624' then a.sale_qty end) sale_qty,
	sum(case when a.sdt between '20230524' and '20230624' then a.profit end)/abs(sum(case when a.sdt between '20230524' and '20230624' then a.sale_amt end)) as profit_rate,
	count(distinct case when a.sdt between '20230524' and '20230624' then a.customer_code end) customer_cnt,
	count(distinct case when a.sdt between '20230524' and '20230624' then a.sdt end) as day_cnt,
	count(case when a.sdt between '20230524' and '20230624' then a.goods_code end) as goods_cnt,
	--
	sum(case when a.sdt between '20230625' and '20230724' then a.sale_amt end) sale_amt,
	sum(case when a.sdt between '20230625' and '20230724' then a.sale_qty end) sale_qty,
	sum(case when a.sdt between '20230625' and '20230724' then a.profit end)/abs(sum(case when a.sdt between '20230625' and '20230724' then a.sale_amt end)) as profit_rate,
	count(distinct case when a.sdt between '20230625' and '20230724' then a.customer_code end) customer_cnt,
	count(distinct case when a.sdt between '20230625' and '20230724' then a.sdt end) as day_cnt,
	count(case when a.sdt between '20230625' and '20230724' then a.goods_code end) as goods_cnt
from 
	(
	select 
	...
	where 
		sdt between '20230524' and '20230724'
...
select
	...
	sum(case when a.sdt between '20230524' and '20230624' then a.sale_qty end) sale_qty,
	count(distinct case when a.sdt between '20230524' and '20230624' then a.sdt end) as day_cnt,
	count(case when a.sdt between '20230524' and '20230624' then a.goods_code end) goods_cnt,
	sum(case when a.sdt between '20230524' and '20230624' then a.profit end) as profit,
	--
	sum(case when a.sdt between '20230625' and '20230724' then a.sale_amt end) sale_amt,
	sum(case when a.sdt between '20230625' and '20230724' then a.sale_qty end) sale_qty,
	count(distinct case when a.sdt between '20230625' and '20230724' then a.sdt end) as day_cnt,
	count(case when a.sdt between '20230625' and '20230724' then a.goods_code end) goods_cnt,
	sum(case when a.sdt between '20230625' and '20230724' then a.profit end) as profit
from 
	(
	select 
