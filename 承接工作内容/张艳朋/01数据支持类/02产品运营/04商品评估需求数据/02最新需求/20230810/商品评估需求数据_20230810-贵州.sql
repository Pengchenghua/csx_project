...
from
	...
	where 
		sdt between '20230609' and '20230809'
...
select
	...
	sum(case when a.sdt between '20230609' and '20230709' then a.profit end)/abs(sum(case when a.sdt between '20230609' and '20230709' then a.sale_amt end)) as profit_rate,
	count(distinct case when a.sdt between '20230609' and '20230709' then a.customer_code end) customer_cnt,
	count(distinct case when a.sdt between '20230609' and '20230709' then a.sdt end) as day_cnt,
	count(case when a.sdt between '20230609' and '20230709' then a.goods_code end) as goods_cnt,
	--
	...
	sum(case when a.sdt between '20230710' and '20230809' then a.profit end)/abs(sum(case when a.sdt between '20230710' and '20230809' then a.sale_amt end)) as profit_rate,
	count(distinct case when a.sdt between '20230710' and '20230809' then a.customer_code end) customer_cnt,
	count(distinct case when a.sdt between '20230710' and '20230809' then a.sdt end) as day_cnt,
	count(case when a.sdt between '20230710' and '20230809' then a.goods_code end) as goods_cnt
from 
