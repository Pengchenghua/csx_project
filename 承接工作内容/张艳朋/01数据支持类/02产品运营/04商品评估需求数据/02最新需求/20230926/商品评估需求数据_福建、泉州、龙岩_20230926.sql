...
from
	...
	where 
		...
		and inventory_dc_code in('W0L3','WA96')
		--and(
		--	(inventory_dc_code in('W0Q2','W0A7','W0X2','W0Z9') and delivery_type_code not in (2,3)) 
		--	or (inventory_dc_code in('W0A6') and delivery_type_code!=2)
		--	)
	) a 
	left join
		(
