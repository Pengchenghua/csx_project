...
insert overwrite table csx_analyse.csx_analyse_fr_product_pool_change_di partition(sdt)		
select
...
from
	(
	select
		c.performance_region_code,c.performance_region_name,c.performance_province_code,c.performance_province_name,c.performance_city_code,c.performance_city_name,
		...
		a.id,a.inventory_dc_code,a.inventory_dc_name,a.main_product_code,a.main_product_name,a.unit,a.sales_amount,a.profit_margin,a.sap_cus_code,a.sap_cus_name,a.status,a.status_name,a.operator_by,
...
group by 
	a.performance_region_code,a.performance_region_name,a.performance_province_code,a.performance_province_name,a.performance_city_code,a.performance_city_name,
	a.inventory_dc_code,a.operator_by,
...
create table csx_analyse.csx_analyse_fr_product_pool_change_di(
