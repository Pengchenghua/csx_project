...
select
	...
	coalesce(a.month_ago_1_sale_amt,a.month_ago_2_sale_amt,a.month_ago_3_sale_amt,0) as change_before_sale_amt,
	coalesce(a.month_ago_1_profit,a.month_ago_2_profit,a.month_ago_3_profit,0) as change_before_profit,
	coalesce(a.month_ago_1_profit,a.month_ago_2_profit,a.month_ago_3_profit,0)/
	abs(coalesce(a.month_ago_1_sale_amt,a.month_ago_2_sale_amt,a.month_ago_3_sale_amt,0)) as change_before_profit_rate,
