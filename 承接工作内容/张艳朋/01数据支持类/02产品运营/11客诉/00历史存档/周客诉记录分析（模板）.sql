...
as
select 
	a.sdt,e.week_of_year,a.performance_region_name,a.performance_province_name,a.customer_code,c.customer_name,c.first_category_name,c.second_category_name,
...
-- 销售
select
	b.week_of_year,customer_code,sum(sale_amt) as sale_amt,sum(profit) as profit
from
	(
	select
	...
	where 
		sdt>='20230101' and sdt<='20230521'
		and channel_code in('1','7','9')
		and customer_code in ('129558','130433','130033','118610','150123','130133','105801','120803','223613')
	) a 
	left join
		(
		select
