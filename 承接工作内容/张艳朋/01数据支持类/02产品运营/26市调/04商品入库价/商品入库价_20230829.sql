	--t3.performance_province_name as `省份`,
	--t2.business_division_name as `生鲜or食百`,
	--t1.dc_code as `仓`,
	--t2.classify_middle_name as `管理中类名称`,
	--t1.goods_code as `商品编码`,
	--t2.goods_name as `商品名称`, 
	--t1.all_received_amount as `入库额`,
	--t1.all_received_qty as `入库量`,
	--t1.avg_price as `平均入库价`,
	--t1.accounting_stock_price as `昨日库存平均价`,
	--t1.fin_price as `最终价格` 
