...
from	
	...
	where 
		sdt between '20190101' and '20210530'
	...
	join
		(
		select 
			customer_no,customer_name,attribute,first_supervisor_work_no,first_supervisor_name,work_no,sales_name,dev_source_name,attribute_desc,sign_time,
...
-- where
-- 	datediff(date_sub(current_date,1),to_date(from_unixtime(unix_timestamp(max_sdt,'yyyyMMdd'))))>=90