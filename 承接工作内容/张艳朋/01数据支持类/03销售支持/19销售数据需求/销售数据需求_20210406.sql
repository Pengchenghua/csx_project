数据需求： business_type_code 1-6
一、1、2、3月各省区如上业务类型，客户销售金额，总销售额金额，客户数量；20年1季度和20年4季度如上业务销售金额，按月统计；
...
履约天数类型：总履约天数<=3 履约磨合期 
合同结束：销售天数>=256天
履约中：3-256天

--============================================================================================================================================================
-- 一、1、2、3月各省区如上业务类型，客户销售金额，总销售额金额，客户数量；20年1季度和20年4季度如上业务销售金额，按月统计；
insert overwrite directory '/tmp/zhangyanpeng/20210406_linshi_1' row format delimited fields terminated by '\t' 
select
	a.s_sdt,
	a.province_name,
	a.customer_no,
