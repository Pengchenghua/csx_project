...
drop table if exists csx_analyse_tmp.csx_analyse_tmp_toubiao_20230104;
create table csx_analyse_tmp.csx_analyse_tmp_toubiao_20230104
as
select 
...
;
select * from csx_analyse_tmp.csx_analyse_tmp_toubiao_20230104
