...
insert overwrite directory '/tmp/zhangyanpeng/20210526_linshi_1' row format delimited fields terminated by '\t' 

select 
	a.province_name,a.city_group_name,a.customer_no,b.customer_name,b.sales_name,a.sales_value,a.profit,
	c.table_type_name,b.sign_time,a.sign_company_code,c.name,b.first_category_name,b.second_category_name
from 
	(
	select
