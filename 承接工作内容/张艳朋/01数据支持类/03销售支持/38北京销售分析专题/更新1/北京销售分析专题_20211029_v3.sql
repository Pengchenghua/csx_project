...
drop table csx_tmp.tmp_customer_business_type;
create table csx_tmp.tmp_customer_business_type
as  
select '112554' as customer_no,'投标' as business_type_name
	union all select '104346' as customer_no,'投标' as business_type_name
	union all select '114819' as customer_no,'投标' as business_type_name
	union all select '116008' as customer_no,'投标' as business_type_name
	union all select '105696' as customer_no,'投标' as business_type_name
	union all select '114586' as customer_no,'投标' as business_type_name
	union all select '114042' as customer_no,'投标' as business_type_name
	union all select '113602' as customer_no,'投标' as business_type_name
	union all select '119619' as customer_no,'投标' as business_type_name
	union all select '111893' as customer_no,'投标' as business_type_name
	union all select '107555' as customer_no,'投标' as business_type_name
	union all select '116845' as customer_no,'投标' as business_type_name
	union all select '107949' as customer_no,'投标' as business_type_name
	union all select '104307' as customer_no,'投标' as business_type_name
	union all select '115768' as customer_no,'投标' as business_type_name
	union all select '120532' as customer_no,'投标' as business_type_name
	union all select '111100' as customer_no,'投标' as business_type_name
	union all select '113770' as customer_no,'投标' as business_type_name
	union all select '104319' as customer_no,'投标' as business_type_name
	union all select '121023' as customer_no,'投标' as business_type_name
	union all select '106852' as customer_no,'投标' as business_type_name
	union all select '114816' as customer_no,'投标' as business_type_name
	union all select '119689' as customer_no,'投标' as business_type_name
	union all select '120487' as customer_no,'投标' as business_type_name
	union all select '104353' as customer_no,'投标' as business_type_name
	union all select '106562' as customer_no,'投标' as business_type_name
	union all select '109533' as customer_no,'投标' as business_type_name
	union all select '114718' as customer_no,'投标' as business_type_name
	union all select '114716' as customer_no,'投标' as business_type_name
	union all select '106214' as customer_no,'投标' as business_type_name
	union all select '103151' as customer_no,'投标' as business_type_name
	union all select '112027' as customer_no,'投标' as business_type_name
	union all select '104362' as customer_no,'投标' as business_type_name
	union all select '116068' as customer_no,'投标' as business_type_name
	union all select '104701' as customer_no,'投标' as business_type_name
	union all select '111541' as customer_no,'投标' as business_type_name
	union all select '120176' as customer_no,'投标' as business_type_name
	union all select '119261' as customer_no,'投标' as business_type_name
	union all select '114715' as customer_no,'投标' as business_type_name
	union all select '117103' as customer_no,'投标' as business_type_name
	union all select '115352' as customer_no,'投标' as business_type_name
	union all select '104529' as customer_no,'投标' as business_type_name
	union all select '114670' as customer_no,'投标' as business_type_name
	union all select '113727' as customer_no,'投标' as business_type_name
	union all select '119665' as customer_no,'投标' as business_type_name
	union all select '117091' as customer_no,'投标' as business_type_name
	union all select '111608' as customer_no,'投标' as business_type_name
	union all select '105695' as customer_no,'投标' as business_type_name
	union all select '112956' as customer_no,'投标' as business_type_name
	union all select '103189' as customer_no,'投标' as business_type_name
	union all select '113131' as customer_no,'投标' as business_type_name
	union all select '106287' as customer_no,'投标' as business_type_name
	union all select '113670' as customer_no,'投标' as business_type_name
	union all select '112298' as customer_no,'投标' as business_type_name
	union all select '109816' as customer_no,'投标' as business_type_name
	union all select '105686' as customer_no,'投标' as business_type_name
	union all select '107782' as customer_no,'投标' as business_type_name
	union all select '104342' as customer_no,'投标' as business_type_name
	union all select '107950' as customer_no,'投标' as business_type_name
	union all select '114303' as customer_no,'投标' as business_type_name
	union all select '112675' as customer_no,'投标' as business_type_name
	union all select '105366' as customer_no,'投标' as business_type_name
	union all select '119657' as customer_no,'投标' as business_type_name
;
...
select
	...
	case when coalesce(b.business_type_name,a.business_type_name)='' then '非投标' else coalesce(b.business_type_name,a.business_type_name) end as business_type_name,
	count(distinct a.customer_no) as customer_cnt
from
	(
	select
		province_name,sdt,customer_no,business_type_name
	from
		csx_dw.dws_crm_w_a_customer
	where 
		(sdt = '20210131'
	...
	left join csx_tmp.tmp_customer_business_type b on b.customer_no=a.customer_no
group by 
	a.province_name,
	substr(a.sdt,1,6),
	case when coalesce(b.business_type_name,a.business_type_name)='' then '非投标' else coalesce(b.business_type_name,a.business_type_name) end
;
...
select
	b.province_name,
	a.smonth,
	case when coalesce(c.business_type_name,b.business_type_name)='' then '非投标' else coalesce(c.business_type_name,b.business_type_name) end as business_type_name,
	sum(a.sales_value) sales_value,
	sum(a.profit) as profit,
	sum(a.profit)/abs(sum(a.sales_value)) as profit_rate,
	count(distinct a.customer_no) as customer_cnt
from
	...
	left join csx_tmp.tmp_customer_business_type c on c.customer_no=a.customer_no
group by
	b.province_name,
	a.smonth,
	case when coalesce(c.business_type_name,b.business_type_name)='' then '非投标' else coalesce(c.business_type_name,b.business_type_name) end
;
...
select
	a.province_name,
	regexp_replace(substr(a.sign_time,1,7),'-','') as smonth,
	case when coalesce(b.business_type_name,a.business_type_name)='' then '非投标' else coalesce(b.business_type_name,a.business_type_name) end as business_type_name,
	count(distinct a.customer_no) as customer_cnt,
	sum(cast(a.estimate_contract_amount as int)) as estimate_contract_amount
from
	(
	select
		province_name,sign_time,business_type_name,customer_no,estimate_contract_amount
	from
		csx_dw.dws_crm_w_a_customer
	where 
		sdt = 'current'
	...
	left join csx_tmp.tmp_customer_business_type b on b.customer_no=a.customer_no
group by 	
	a.province_name,regexp_replace(substr(a.sign_time,1,7),'-',''),
	case when coalesce(b.business_type_name,a.business_type_name)='' then '非投标' else coalesce(b.business_type_name,a.business_type_name) end	
;
...
select
	...
	sum(a.sales_value)/count(distinct smonth) as avg_sales_value,
	sum(a.profit)/count(distinct smonth) as avg_profit,
	sum(a.front_profit)/count(distinct smonth) as avg_front_profit_rate
from
	(
	select 
		customer_no,substr(sdt,1,6) as smonth,sales_value,profit,front_profit,work_no,sales_name
	from 
		csx_dw.dws_sale_r_d_detail
	where 
		sdt>='20210701' and sdt<='20210930'
	...
	left join 
		...
		select
			customer_no,customer_name,work_no,sales_name,first_supervisor_work_no,first_supervisor_name,first_category_name,second_category_name,third_category_name,attribute_desc,
			sales_region_name,sales_province_name,province_name,regexp_replace(substr(sign_time,1,10),'-','') as sign_date,estimate_contract_amount,city_group_name
		from
			csx_dw.dws_crm_w_a_customer
		where 
			sdt = 'current'
...
select
	...
	b.second_category_name,b.third_category_name,b.attribute_desc,b.sign_date,a.max_sdt
from
	(
	select 
		customer_no,
