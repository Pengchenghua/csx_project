drop table if exists csx_analyse_tmp.csx_analyse_tmp_sale_beijing_rp;
create table csx_analyse_tmp.csx_analyse_tmp_sale_beijing_rp
as 
select
...
from
	...
	left join
		...
		select
			...
			sales_user_number,sales_user_name,customer_address_full,contact_person,contact_phone
		from
...
;
select * from csx_analyse_tmp.csx_analyse_tmp_sale_beijing_rp