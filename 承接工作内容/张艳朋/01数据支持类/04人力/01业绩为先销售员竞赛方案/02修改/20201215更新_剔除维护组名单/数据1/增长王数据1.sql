...
select
	concat_ws('-', substr('20200501',5,4),substr('20200531',5,4)) as statistic_month,
...
from
	...
	where 
		...
		and (to_date(sign_time)>='2020-07-01'
			or work_no not in ('81022625','80795486','80548045','80796125','80930620','80857686','81020490','80203532','81004930','80927348','80141332','80663108','80796343','80142191','80949208','80980614','80972915','80960666','80816155','80012225','80764642','80952742','80973546','80928572','80895351','80255598','80691224','80680804'))
	group by 
		province_name,city_real,supervisor_work_no,supervisor_name,work_no,sales_name
	) a 
	left join
		...
		from 
			csx_dw.dws_sale_r_d_customer_sale
		where 
			sdt between '20200401' and '20200430'
			and channel in ('1','7','9') --1大客户2商超4大宗5供应链食百6供应链生鲜7企业购9业务代理
			and province_name not like '平台%'	
			and first_category_code in ('21', '23') --21企事业单位 22商贸批发 23餐饮企业 24食品加工企业 25个人及其他
			and attribute_code in (1, 2) --客户属性 1:日配客户 2:福利客户 3:贸易客户 4:战略客户 5:合伙人客户
