...
select
	concat_ws('-', substr('20201101',5,4),substr('20201130',5,4)) as statistic_month,
...
from
	...
	where 
		...
		and customer_no not in ('114629','114675','114715','114718','114720','114812','114833','114857','114904','114911','114922','114933','115053','115145')
	group by 
		province_name,city_real,supervisor_work_no,supervisor_name,work_no,sales_name
	) a 
	left join
