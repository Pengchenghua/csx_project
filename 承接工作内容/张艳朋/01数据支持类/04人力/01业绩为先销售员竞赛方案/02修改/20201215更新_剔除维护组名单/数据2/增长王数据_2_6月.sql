...
select
	concat_ws('-', substr('20200601',5,4),substr('20200630',5,4)) as statistic_month,
...
from
	...
	where 
		sdt between '20200601' and '20200630'
		...
		and customer_no not in ('108067','111374','111844','111860','112027','112028','112029','112043','112051','112066','112129','112144','112152','112169','112213','112214','112244','112272','112276','112298','112378','112385','112409','112471','112494','112526','112586')
	group by 
		province_name,city_real,supervisor_work_no,supervisor_name,work_no,sales_name
	) a 
	left join
