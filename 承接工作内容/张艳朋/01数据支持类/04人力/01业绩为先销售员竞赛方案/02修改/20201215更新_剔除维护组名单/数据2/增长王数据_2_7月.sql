...
select
	concat_ws('-', substr('20200701',5,4),substr('20200731',5,4)) as statistic_month,
...
from
	...
	where 
		...
		and customer_no not in ('111838','112002','112038','112080','112085','112133','112319','112521','112554','112623','112632','112675','112689','112778','112793','112942','112956','112965','112976','112980','113038')
	group by 
		province_name,city_real,supervisor_work_no,supervisor_name,work_no,sales_name
	) a 
	left join
