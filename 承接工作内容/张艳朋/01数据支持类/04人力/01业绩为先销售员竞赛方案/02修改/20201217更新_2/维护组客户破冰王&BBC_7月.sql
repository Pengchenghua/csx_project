...
-- 昨日
set i_sdate ='2020-07-31';
set i_sdate_11 =regexp_replace('2020-07-31','-','');

--昨日月1日
set i_sdate_12 =regexp_replace(trunc('2020-07-31','MM'),'-','');
	...
	from	
		...
		from
			...
			where 
				...
				and customer_no in ('112632','112942','112038','112778','112319','112976','112980','112623','111838','112793','112675','112956','112085','112554','112965','112080','112521','112002','112133','112689','113038')
			group by
				customer_no,province_name,city_real,supervisor_work_no,supervisor_name,work_no,sales_name,order_no
			) a 
			left join
