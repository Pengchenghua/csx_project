...
-- 昨日
set i_sdate ='2020-08-31';
set i_sdate_11 =regexp_replace('2020-08-31','-','');

--昨日月1日
set i_sdate_12 =regexp_replace(trunc('2020-08-31','MM'),'-','');
	...
	from	
		...
		from
			...
			where 
				...
				and customer_no in ('113602','113457','113358','113624','113169','113149','113256','113247','113226','113210','113135','113032','113526','113101','112032','113286','113263')
			group by
				customer_no,province_name,city_real,supervisor_work_no,supervisor_name,work_no,sales_name,order_no
			) a 
			left join
