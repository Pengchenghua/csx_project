...
set i_sdate_11 =regexp_replace('2020-09-30','-','');

--昨日月1日
set i_sdate_12 =regexp_replace(trunc('2020-09-30','MM'),'-','');
	...
	from	
		...
		from
			...
			where 
				...
				and customer_no in ('114450','114340','114253','114275','114042','113849','114015','113992','113961','113923','113853','113858','113718','113806','113770','113727','113615','113558','113533','113548','113514','113467','113456','113107','112923','112799','112231','113890','113930','113949','113796','114134','111283','113635','113646','102524')
			group by
				customer_no,province_name,city_real,supervisor_work_no,supervisor_name,work_no,sales_name,order_no
			) a 
			left join
