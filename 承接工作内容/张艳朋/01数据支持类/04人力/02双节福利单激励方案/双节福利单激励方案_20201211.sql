...
from
	(
	select
		province_name,city_real,supervisor_work_no,supervisor_name,work_no,sales_name,customer_no,order_no,order_kind,
	...
	where 
		sdt between '20201201' and '20201210'
...
where
	...
	and((t2.attribute not in ('合伙人客户','贸易客户') and t1.order_kind='WELFARE') -- 福利单
		or 
		(t2.attribute='贸易客户' and t1.order_profit_rate>0.015 and t1.order_kind='WELFARE')) -- 贸易客户>1.5%大宗的福利单标识订单
group by
	province_name,city_real,supervisor_work_no,supervisor_name,work_no,sales_name,t5.begin_date
-- having
