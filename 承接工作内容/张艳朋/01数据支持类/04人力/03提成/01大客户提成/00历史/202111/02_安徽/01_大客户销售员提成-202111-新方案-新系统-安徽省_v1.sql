...
from 
	...
	union all  select '20211130' as sdt,'202111' as smonth,'福建省' as province_name,'120880' as customer_no,
		-53982 as sales_value, 0 as profit,1 prorate,14.4 as front_profit,1 as fnl_prorate
	union all  select '20211130' as sdt,'202111' as smonth,'福建省' as province_name,'116631' as customer_no,
		-71976 as sales_value, 0 as profit,1 prorate,-1.74 as front_profit,1 as fnl_prorate
	union all  select '20211130' as sdt,'202111' as smonth,'福建省' as province_name,'123452' as customer_no,
		-179940 as sales_value, 0 as profit,1 prorate,-84603.6 as front_profit,1 as fnl_prorate
	union all  select '20211130' as sdt,'202111' as smonth,'福建省' as province_name,'123440' as customer_no,
		-265110 as sales_value, 0 as profit,1 prorate,-121611.96 as front_profit,1 as fnl_prorate
	union all  select '20211130' as sdt,'202111' as smonth,'福建省' as province_name,'122609' as customer_no,
		-34848 as sales_value, 0 as profit,1 prorate,-2377.8 as front_profit,1 as fnl_prorate
	union all  select '20211130' as sdt,'202111' as smonth,'福建省' as province_name,'106877' as customer_no,
		-6500 as sales_value, 0 as profit,1 prorate,-1970.44 as front_profit,1 as fnl_prorate
	union all  select '20211130' as sdt,'202111' as smonth,'福建省' as province_name,'123374' as customer_no,
		-11994 as sales_value, 0 as profit,1 prorate,-0.06 as front_profit,1 as fnl_prorate
	union all  select '20211130' as sdt,'202111' as smonth,'福建省' as province_name,'123484' as customer_no,
		-125958 as sales_value, 0 as profit,1 prorate,-0.42 as front_profit,1 as fnl_prorate
...
-- 处理客户城市	
drop table csx_tmp.tmp_tc_customer_info;
create table csx_tmp.tmp_tc_customer_info
as  
select
...
from
	...
	select 
		...
		case when work_no in ('81094377','81137952','80874925','81146863','81146865','81142814') then '滁州'
			when work_no in ('80926384','81090692') then '蚌埠'
