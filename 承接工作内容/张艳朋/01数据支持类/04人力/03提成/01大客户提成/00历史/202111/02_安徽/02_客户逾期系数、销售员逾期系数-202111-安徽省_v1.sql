...
where 
	...
	'113635','113646','114344','115324','115595','115602','115646','115656','115679','115826','115857','116123','116211','117244','118687','PF0094','PF1205','103995','107683',
...
union all   select '118819' as customer_no,'80941561' as service_user_work_no,'杨艳' as service_user_name,'80928418' as work_no,'宋伟静' as sales_name,'否' as is_part_time_service_manager,0.9 as sales_sale_rate,0.8 as sales_front_profit_rate,0.1 as service_user_sale_rate,0.2 as service_user_front_profit_rate
...
union all   select '123107' as customer_no,'80941561' as service_user_work_no,'杨艳' as service_user_name,'80928418' as work_no,'宋伟静' as sales_name,'否' as is_part_time_service_manager,0.9 as sales_sale_rate,0.8 as sales_front_profit_rate,0.1 as service_user_sale_rate,0.2 as service_user_front_profit_rate
...
left join
	...
	where sdt=${hiveconf:i_sdate_11} 
		...
		join
			(
			select * from csx_tmp.tmp_tc_customer_info
...
left join		
	...
	from 
		...
		join
			(
			select * from csx_tmp.tmp_tc_customer_info
			) y on y.customer_no=a.customer_no	
where 
