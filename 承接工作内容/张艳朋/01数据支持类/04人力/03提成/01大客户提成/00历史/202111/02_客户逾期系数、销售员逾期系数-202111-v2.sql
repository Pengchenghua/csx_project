...
where 
	...
	'111892','112210','117022','105483','106300','117067','120031','106521','115742','117068','122532','122606'
	)
...
union all   select '119688' as customer_no,'80912927' as service_user_work_no,'刘秋霞' as service_user_name,'81010913' as work_no,'刘华伟' as sales_name,'否' as is_part_time_service_manager,0.1 as sales_sale_rate,0.2 as sales_front_profit_rate,0.1 as service_user_sale_rate,0.2 as service_user_front_profit_rate
...
from
	...
	where channel_name = '大客户' and sdt = ${hiveconf:i_sdate_11} 
		...
		--202111月签呈，剔除逾期，每月处理
		and customer_no not in ('111204','120317')
	group by 
