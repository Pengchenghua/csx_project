...
load data inpath '/tmp/zhangyanpeng/sales_income_info_02.csv' overwrite into table csx_tmp.sales_income_info partition (sdt='20220228');
select * from csx_tmp.sales_income_info where sdt='20220228';
