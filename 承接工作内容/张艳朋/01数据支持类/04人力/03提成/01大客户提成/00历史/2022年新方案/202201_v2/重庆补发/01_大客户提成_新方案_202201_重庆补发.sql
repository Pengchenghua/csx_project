...
from 
	...
	--202201月签呈，福建省，当月
	union all select '117108' as customer_no,'202201' as smonth,0 as customer_sales_value, 0 as customer_ripei_bbc_sales_value,0 as customer_fuli_sales_value,
	-10000.00 as customer_profit,-10000.00 as customer_ripei_bbc_profit, 0.00 as customer_fuli_profit
	union all select '107806' as customer_no,'202201' as smonth,0 as customer_sales_value, 0 as customer_ripei_bbc_sales_value,0 as customer_fuli_sales_value,
	-7529.00 as customer_profit,0.00 as customer_ripei_bbc_profit, -7529.00 as customer_fuli_profit
...
from
	...
	left join
		...
		--202201月签呈，福建省，每月
		union all select '102734' as customer_no, 0.01 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '102784' as customer_no, 0.01 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '102901' as customer_no, 0.01 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '113263' as customer_no, 0.03 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '115366' as customer_no, 0.03 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select 'PF0649' as customer_no, 0.09 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '114038' as customer_no, 0.05 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '113088' as customer_no, 0.04 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '102924' as customer_no, 0.03 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '102524' as customer_no, 0.03 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '105703' as customer_no, 0.01 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '105750' as customer_no, 0.01 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '106698' as customer_no, 0.01 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '112553' as customer_no, 0.01 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '113678' as customer_no, 0.01 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '113679' as customer_no, 0.01 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '113746' as customer_no, 0.01 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '113760' as customer_no, 0.01 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '113805' as customer_no, 0.01 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '115602' as customer_no, 0.01 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '117244' as customer_no, 0.01 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '104281' as customer_no, 0.01 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '107398' as customer_no, 0.01 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		--union all select '115073' as customer_no, 0.01 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		--union all select '115898' as customer_no, 0.02 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '108589' as customer_no, 0.03 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '120459' as customer_no, 0.03 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '118653' as customer_no, 0.05 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '118654' as customer_no, 0.05 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '118682' as customer_no, 0.05 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '118705' as customer_no, 0.05 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '118730' as customer_no, 0.05 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '118934' as customer_no, 0.05 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '118961' as customer_no, 0.05 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '119185' as customer_no, 0.05 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '119172' as customer_no, 0.05 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '120666' as customer_no, 0.05 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '115961' as customer_no, 0.03 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '115985' as customer_no, 0.03 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '118689' as customer_no, 0.02 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '116355' as customer_no, 0.02 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '105150' as customer_no, 0.10 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '105156' as customer_no, 0.10 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '105177' as customer_no, 0.10 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '105181' as customer_no, 0.10 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '105182' as customer_no, 0.10 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '106423' as customer_no, 0.10 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '106721' as customer_no, 0.10 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '107404' as customer_no, 0.10 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '105164' as customer_no, 0.10 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '105165' as customer_no, 0.10 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '119990' as customer_no, 0.10 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '106805' as customer_no, 0.10 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '117676' as customer_no, 0.05 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '123252' as customer_no, 0.08 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '108557' as customer_no, 0.02 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '116707' as customer_no, 0.03 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '116561' as customer_no, 0.05 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '120250' as customer_no, 0.03 as ripei_bbc_kd_rate, 0.00 as fuli_kd_rate
		union all select '119213' as customer_no, 0.00 as ripei_bbc_kd_rate, 0.01 as fuli_kd_rate
		union all select '113515' as customer_no, 0.00 as ripei_bbc_kd_rate, 0.01 as fuli_kd_rate
		union all select '106587' as customer_no, 0.00 as ripei_bbc_kd_rate, 0.05 as fuli_kd_rate
		union all select '116131' as customer_no, 0.00 as ripei_bbc_kd_rate, 0.06 as fuli_kd_rate
		union all select '103782' as customer_no, 0.00 as ripei_bbc_kd_rate, 0.06 as fuli_kd_rate
		union all select '115656' as customer_no, 0.01 as ripei_bbc_kd_rate, 0.01 as fuli_kd_rate
		union all select '115826' as customer_no, 0.01 as ripei_bbc_kd_rate, 0.01 as fuli_kd_rate
		union all select '121054' as customer_no, 0.02 as ripei_bbc_kd_rate, 0.02 as fuli_kd_rate
		union all select '116947' as customer_no, 0.01 as ripei_bbc_kd_rate, 0.01 as fuli_kd_rate
		union all select '111207' as customer_no, 0.01 as ripei_bbc_kd_rate, 0.01 as fuli_kd_rate
		union all select '125534' as customer_no, 0.01 as ripei_bbc_kd_rate, 0.01 as fuli_kd_rate
		union all select '115537' as customer_no, 0.01 as ripei_bbc_kd_rate, 0.01 as fuli_kd_rate
...
select 
	...
	if(a.sales_province_name in ('福建省'),coalesce(a.customer_fuli_sales_value*a.salesperson_fuli_sales_value_tc_rate,0),0) as salary_fuli_sales_value,
	if(a.sales_province_name in ('福建省'),coalesce(a.customer_fuli_profit*e.salesperson_fuli_profit_tc_rate,0),0) as salary_fuli_profit,
	if(a.sales_province_name in ('福建省'),coalesce(a.customer_ripei_bbc_sales_value*a.salesperson_ripei_bbc_sales_value_tc_rate,0),
	...
	if(a.sales_province_name in ('福建省'),coalesce(a.customer_ripei_bbc_profit*e.salesperson_ripei_bbc_profit_tc_rate,0),
...
from  
	...
	select 
		...
		service_user_sales_value_fp_rate,  --服务管家_销售额_分配比例
		service_user_profit_fp_rate, --服务管家_定价毛利额_分配比例
		smonth,customer_sales_value,customer_ripei_bbc_sales_value,customer_fuli_sales_value,customer_profit,
		--202201月签呈，仅计算销售额，不计算定价毛利额，当月
		if(customer_no in ('119990'),0,customer_ripei_bbc_profit) as customer_ripei_bbc_profit,
		if(customer_no in ('119990'),0,customer_fuli_profit) as customer_fuli_profit,
...
select 
	...
	a.salary_fuli_sales_value*(1-coalesce(if(a.salesperson_over_rate<=0.5,a.salesperson_over_rate,1),0))*if(a.customer_no in ('103096'),0.7,1) as salary_fuli_sales_value_salesperson,
	a.salary_fuli_profit*(1-coalesce(if(a.salesperson_over_rate<=0.5,a.salesperson_over_rate,1),0))*if(a.customer_no in ('103096'),0.5,1) as salary_fuli_profit_salesperson,
	--提成_销售额_销售员
	...
	if(a.sales_province_name in ('福建省'),a.salary_sales_value*(1-coalesce(if(a.salesperson_over_rate<=0.5,a.salesperson_over_rate,1),0))*0.7,
	salary_sales_value*(1-coalesce(if(a.salesperson_over_rate<=0.5,a.salesperson_over_rate,1),0))*coalesce(a.salesperson_sales_value_fp_rate,0)) as salary_sales_value_salesperson, --提成_销售额_销售员
	--提成_销售额_服务管家
	...
	if(a.sales_province_name in ('福建省'),a.salary_profit*(1-coalesce(if(a.salesperson_over_rate<=0.5,a.salesperson_over_rate,1),0))*0.5,
	a.salary_profit*(1-coalesce(if(a.salesperson_over_rate<=0.5,a.salesperson_over_rate,1),0))*coalesce(a.salesperson_profit_fp_rate,0)) salary_profit_salesperson,--提成_定价毛利额_销售员
	--提成_定价毛利额_服务管家
...
select 
	...
	customer_profit,customer_ripei_bbc_profit,customer_fuli_profit,customer_prorate,customer_ripei_bbc_prorate,customer_fuli_prorate,salesperson_ripei_bbc_prorate,salesperson_fuli_prorate,
	salary_fuli_sales_value,salary_fuli_profit,salary_sales_value,salary_profit,
...
where  
	...
	and sales_province_name in ('重庆市','福建省')
