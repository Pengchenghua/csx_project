...
from 
	...
	--202201月签呈，当月
	--重庆市
	--union all select '107806' as customer_no,'202201' as smonth,0 as sales_value, 0 as rp_sales_value,0 as bbc_sales_value,0 as fl_sales_value,
	---7529.00 as profit,0.00 as rp_profit, 0.00 as bbc_profit, -7529.00 as fl_profit
	--202202月签呈，当月
	--上海宝山

	--202202月签呈，河北省，1-4月
	--union all select '124519' as customer_no,'202202' as smonth,0 as sales_value, 0 as rp_sales_value,0 as bbc_sales_value,0 as fl_sales_value,
...
from
	...
	left join
		...
		union all select '104965' as customer_no, 0.06 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.00 as fl_kd_rate
		union all select '112813' as customer_no, 0.06 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.00 as fl_kd_rate
		union all select '117753' as customer_no, 0.06 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.00 as fl_kd_rate
		union all select '117727' as customer_no, 0.06 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.00 as fl_kd_rate
		union all select '117728' as customer_no, 0.06 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.00 as fl_kd_rate
		union all select '117729' as customer_no, 0.06 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.00 as fl_kd_rate
		union all select '117748' as customer_no, 0.06 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.00 as fl_kd_rate
		union all select '117773' as customer_no, 0.06 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.00 as fl_kd_rate
		union all select '117776' as customer_no, 0.06 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.00 as fl_kd_rate
		union all select '117782' as customer_no, 0.06 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.00 as fl_kd_rate
		union all select '117790' as customer_no, 0.06 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.00 as fl_kd_rate
		union all select '117791' as customer_no, 0.06 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.00 as fl_kd_rate
		union all select '117795' as customer_no, 0.06 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.00 as fl_kd_rate
		union all select '117800' as customer_no, 0.06 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.00 as fl_kd_rate
		union all select '117805' as customer_no, 0.06 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.00 as fl_kd_rate
		union all select '117918' as customer_no, 0.06 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.00 as fl_kd_rate
		union all select '117920' as customer_no, 0.03 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.00 as fl_kd_rate
		union all select '119659' as customer_no, 0.03 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.00 as fl_kd_rate
		union all select '120105' as customer_no, 0.03 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.00 as fl_kd_rate
		union all select '110866' as customer_no, 0.01 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.00 as fl_kd_rate
		union all select '113643' as customer_no, 0.03 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.00 as fl_kd_rate
		union all select '119517' as customer_no, 0.01 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.00 as fl_kd_rate
		union all select '121061' as customer_no, 0.01 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.00 as fl_kd_rate
		union all select '120924' as customer_no, 0.06 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.00 as fl_kd_rate
		union all select '123084' as customer_no, 0.05 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.00 as fl_kd_rate
		union all select '115206' as customer_no, 0.00 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.03 as fl_kd_rate
		union all select '118212' as customer_no, 0.10 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.00 as fl_kd_rate
		union all select '124589' as customer_no, 0.00 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.10 as fl_kd_rate
		union all select '112177' as customer_no, 0.05 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.00 as fl_kd_rate
		union all select '115554' as customer_no, 0.05 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.00 as fl_kd_rate
		union all select '114391' as customer_no, 0.05 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.00 as fl_kd_rate
		union all select '122247' as customer_no, 0.03 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.00 as fl_kd_rate
		union all select '120976' as customer_no, 0.02 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.00 as fl_kd_rate
		union all select '115253' as customer_no, 0.02 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.00 as fl_kd_rate
		union all select '112803' as customer_no, 0.02 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.00 as fl_kd_rate
		...
		union all select '116707' as customer_no, 0.03 as rp_kd_rate, 0.00 as bbc_kd_rate, 0.00 as fl_kd_rate
	...
	left join
		...
		select 
			customer_no,substr(sdt,1,6) as smonth,
			-- 各类型退货金额
			sum(sales_value) as refund_sales_value, 
			sum(case when business_type_code in('1','4') then sales_value else 0 end) as refund_rp_sales_value,
			sum(case when business_type_code in('6') then sales_value else 0 end) as refund_bbc_sales_value,
			sum(case when business_type_code in('1','6','4') then sales_value else 0 end) as refund_rp_bbc_sales_value,
			sum(case when business_type_code in('2') then sales_value else 0 end) as refund_fl_sales_value	
		from 
			csx_dw.dws_sale_r_d_detail
		where 
			sdt>=${hiveconf:month_start_day} and sdt<=${hiveconf:month_end_day}
...
from
	...
	select 	
		work_no,sales_name,
		-- 销售额
		sum(sales_value) as sales_sales_value, -- 总销售额
		sum(rp_sales_value) as sales_rp_sales_value, -- 日配销售额
		sum(bbc_sales_value) as sales_bbc_sales_value, -- bbc销售额
		sum(rp_bbc_sales_value) as sales_rp_bbc_sales_value, -- 日配&bbc销售额
		sum(fl_sales_value) as sales_fl_sales_value, -- 福利销售额
		-- 定价毛利额
		...
		--定价毛利率
		sum(profit)/abs(sum(sales_value)) as sales_prorate, -- 总定价毛利率
		sum(rp_profit)/abs(sum(rp_sales_value)) as sales_rp_prorate,
		sum(bbc_profit)/abs(sum(bbc_sales_value)) as sales_bbc_prorate,
		sum(rp_bbc_profit)/abs(sum(rp_bbc_sales_value)) as sales_rp_bbc_prorate, -- 销售员本月日配&bbc定价毛利率
		sum(fl_profit)/abs(sum(fl_sales_value)) as sales_fl_prorate -- 销售员本月福利定价毛利率
	from
...
as
select 
	a.smonth,a.sales_province_name,a.city_group_name,a.customer_id,a.customer_no,a.customer_name,
	...
	if(a.customer_no in ('123311','124033','118376'),0,a.rp_profit*coalesce(e.sales_rp_bbc_profit_tc_rate,0.03)) as salary_rp_profit, --奖金包_日配定价毛利额
	--奖金包_福利业务
	a.fl_sales_value*coalesce(f.sales_fl_sales_value_tc_rate,0.002) as salary_fl_sales_value, --奖金包_福利销售额
	--202202月签呈，只计算销售额提成，不计算定价毛利额提成，每月
	if(a.customer_no in ('123311','124033','118376'),0,a.fl_profit*coalesce(e.sales_fl_profit_tc_rate,0.02)) as salary_fl_profit, --奖金包_福利定价毛利额
	--奖金包_BBC业务
	a.bbc_sales_value*coalesce(f.sales_rp_bbc_sales_value_tc_rate,0.002) as salary_bbc_sales_value, -- 奖金包_bbc销售额
	--202202月签呈，只计算销售额提成，不计算定价毛利额提成，每月
	if(a.customer_no in ('123311','124033','118376'),0,a.bbc_profit*coalesce(e.sales_rp_bbc_profit_tc_rate,0.03)) as salary_bbc_profit, --奖金包_bbc定价毛利额	
...
from  
	(
	select 
		sales_province_name,city_group_name,customer_no,customer_name,smonth,customer_id,sales_id,work_no,sales_name,rp_service_user_id,rp_service_user_work_no,rp_service_user_name,
...
as
select
	a.smonth,a.sales_province_name,a.city_group_name,a.customer_id,a.customer_no,a.customer_name,a.sales_id,a.work_no,a.sales_name,a.rp_service_user_id,a.rp_service_user_work_no,a.rp_service_user_name,
...
from
	...
	select 
		...
		a.bbc_service_overdue_amount,			
		--提成_日配业务_销售员
		a.salary_rp_sales_value*(1-coalesce(if(a.sales_over_rate<=0.5,a.sales_over_rate,1),0))*coalesce(a.rp_sales_sale_fp_rate,0) as tc_rp_sales_value_sales,
		a.salary_rp_profit*(1-coalesce(if(a.sales_over_rate<=0.5,a.sales_over_rate,1),0))*coalesce(a.rp_sales_profit_fp_rate,0) as tc_rp_profit_sales,		
				
		--提成_福利业务_销售员
		a.salary_fl_sales_value*(1-coalesce(if(a.sales_over_rate<=0.5,a.sales_over_rate,1),0))*coalesce(a.fl_sales_sale_fp_rate,0) as tc_fl_sales_value_sales,
		a.salary_fl_profit*(1-coalesce(if(a.sales_over_rate<=0.5,a.sales_over_rate,1),0))*coalesce(a.fl_sales_profit_fp_rate,0) as tc_fl_profit_sales,
		
		--提成_BBC业务_销售员
		a.salary_bbc_sales_value*(1-coalesce(if(a.sales_over_rate<=0.5,a.sales_over_rate,1),0))*coalesce(a.bbc_sales_sale_fp_rate,0) as tc_bbc_sales_value_sales,
		a.salary_bbc_profit*(1-coalesce(if(a.sales_over_rate<=0.5,a.sales_over_rate,1),0))*coalesce(a.bbc_sales_profit_fp_rate,0) as tc_bbc_profit_sales,		
		
		--提成_日配业务_服务管家
		a.salary_rp_sales_value*(1-coalesce(if(a.rp_service_user_over_rate<=0.5,a.rp_service_user_over_rate,1),0))*coalesce(a.rp_service_user_sale_fp_rate,0) as tc_rp_sales_value_service,
		a.salary_rp_profit*(1-coalesce(if(a.rp_service_user_over_rate<=0.5,a.rp_service_user_over_rate,1),0))*coalesce(a.rp_service_user_profit_fp_rate,0) as tc_rp_profit_service,	

		--提成_福利业务_服务管家
		a.salary_fl_sales_value*(1-coalesce(if(a.fl_service_user_over_rate<=0.5,a.fl_service_user_over_rate,1),0))*coalesce(a.fl_service_user_sale_fp_rate,0) as tc_fl_sales_value_service,
		a.salary_fl_profit*(1-coalesce(if(a.fl_service_user_over_rate<=0.5,a.fl_service_user_over_rate,1),0))*coalesce(a.fl_service_user_profit_fp_rate,0) as tc_fl_profit_service,

		--提成_BBC业务_服务管家
		a.salary_bbc_sales_value*(1-coalesce(if(a.bbc_service_user_over_rate<=0.5,a.bbc_service_user_over_rate,1),0))*coalesce(a.bbc_service_user_sale_fp_rate,0) as tc_bbc_sales_value_service,
		a.salary_bbc_profit*(1-coalesce(if(a.bbc_service_user_over_rate<=0.5,a.bbc_service_user_over_rate,1),0))*coalesce(a.bbc_service_user_profit_fp_rate,0) as tc_bbc_profit_service,			
...
select
	...
	--销售员地区信息
	c.region_code as region_code_sales,c.region_name as region_name_sales,
	c.province_code as province_code_sales,c.province_name as province_name_sales,
	c.city_group_code as city_group_code_sales,c.city_group_name as city_group_name_sales,
	--日配服务管家地区信息
	d.region_code as region_code_rp_service,d.region_name as region_name_rp_service,
	d.province_code as province_code_rp_service,d.province_name as province_name_rp_service,
	d.city_group_code as city_group_code_rp_service,d.city_group_name as city_group_name_rp_service,
	--福利服务管家地区信息
	d2.region_code as region_code_fl_service,d2.region_name as region_name_fl_service,
	d2.province_code as province_code_fl_service,d2.province_name as province_name_fl_service,
	d2.city_group_code as city_group_code_fl_service,d2.city_group_name as city_group_name_fl_service,
	--BBC服务管家地区信息
	d3.region_code as region_code_bbc_service,d3.region_name as region_name_bbc_service,
	d3.province_code as province_code_bbc_service,d3.province_name as province_name_bbc_service,
	d3.city_group_code as city_group_code_bbc_service,d3.city_group_name as city_group_name_bbc_service,
	a.customer_id,a.customer_no,a.customer_name,a.sales_id,a.work_no,a.sales_name,
	a.rp_service_user_id,a.rp_service_user_work_no,a.rp_service_user_name,
	a.fl_service_user_id,a.fl_service_user_work_no,a.fl_service_user_name,a.bbc_service_user_id,a.bbc_service_user_work_no,a.bbc_service_user_name,
	...
	if(a.customer_no in ('124524'),tc_sales*0.5,tc_sales) as tc_sales,
	if(a.customer_no in ('124524'),(tc_rp_sales_value_service+tc_rp_profit_service)*0.5,tc_rp_sales_value_service+tc_rp_profit_service) as tc_rp_service,
	if(a.customer_no in ('124524'),(tc_fl_sales_value_service+tc_fl_profit_service)*0.5,tc_fl_sales_value_service+tc_fl_profit_service) as tc_fl_service,
	if(a.customer_no in ('124524'),(tc_bbc_sales_value_service+tc_bbc_profit_service)*0.5,tc_bbc_sales_value_service+tc_bbc_profit_service) as tc_bbc_service,
	refund_sales_value,refund_rp_sales_value,refund_bbc_sales_value,refund_rp_bbc_sales_value,refund_fl_sales_value
from
