...
from 
	...
	union all select '121061' as customer_no,'202203' as smonth,0 as sales_value, 0 as rp_sales_value,0 as bbc_sales_value,0 as fl_sales_value,
		-50064.80 as profit,-50064.80 as rp_profit, 0.00 as bbc_profit, 0.00 as fl_profit
...
select 
	...
	a.rp_profit*coalesce(e.sales_rp_bbc_profit_tc_rate,0.03) as salary_rp_profit, --奖金包_日配定价毛利额
	--奖金包_福利业务
	a.fl_sales_value*coalesce(f.sales_fl_sales_value_tc_rate,0.002) as salary_fl_sales_value, --奖金包_福利销售额
	a.fl_profit*coalesce(e.sales_fl_profit_tc_rate,0.02) as salary_fl_profit, --奖金包_福利定价毛利额
	--奖金包_BBC业务
	a.bbc_sales_value*coalesce(f.sales_rp_bbc_sales_value_tc_rate,0.002) as salary_bbc_sales_value, -- 奖金包_bbc销售额
	a.bbc_profit*coalesce(e.sales_rp_bbc_profit_tc_rate,0.03) as salary_bbc_profit, --奖金包_bbc定价毛利额	
...
select
	...
	a.sales_sales_value_ytd,a.sales_rp_bbc_sales_value_ytd,a.sales_fl_sales_value_ytd, 
	tc_sales,
	tc_rp_sales_value_service+tc_rp_profit_service as tc_rp_service,
	tc_fl_sales_value_service+tc_fl_profit_service as tc_fl_service,
	tc_bbc_sales_value_service+tc_bbc_profit_service as tc_bbc_service,
	refund_sales_value,refund_rp_sales_value,refund_bbc_sales_value,refund_rp_bbc_sales_value,refund_fl_sales_value
from
