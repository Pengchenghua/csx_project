...
select 
	distinct province_name,customer_id,customer_no,customer_name,
	if(customer_no in ('123311','124033','118376','124524'),'1000000567740',sales_id) as sales_id,
	if(customer_no in ('123311','124033','118376','124524'),'81103065',work_no) as work_no,
	if(customer_no in ('123311','124033','118376','124524'),'王世超',sales_name) as sales_name,
	case when customer_no in ('118376','123311') then '1000000567737' 
		when customer_no in ('124033') then '1000000211352' 
		when customer_no in ('124524') then null else rp_service_user_id end as rp_service_user_id,
	case when customer_no in ('118376','123311') then '81103328' 
		when customer_no in ('124033') then '81020509' 
		when customer_no in ('124524') then null else rp_service_user_work_no end as rp_service_user_work_no,		
	case when customer_no in ('118376','123311') then '武艳' 
		when customer_no in ('124033') then '陈素彩' 
		when customer_no in ('124524') then null else rp_service_user_name end as rp_service_user_name,		
	...
	if(customer_no in ('123311','124033','118376','124524'),0.9,rp_sales_sale_fp_rate) as rp_sales_sale_fp_rate,
	if(customer_no in ('123311','124033','118376','124524'),0.8,rp_sales_profit_fp_rate) as rp_sales_profit_fp_rate,
	if(customer_no in ('123311','124033','118376','124524'),0.9,fl_sales_sale_fp_rate) as fl_sales_sale_fp_rate,
	if(customer_no in ('123311','124033','118376','124524'),0.8,fl_sales_profit_fp_rate) as fl_sales_profit_fp_rate,
	if(customer_no in ('123311','124033','118376','124524'),0.9,bbc_sales_sale_fp_rate) as bbc_sales_sale_fp_rate,
	if(customer_no in ('123311','124033','118376','124524'),0.8,bbc_sales_profit_fp_rate) as bbc_sales_profit_fp_rate,
	if(customer_no in ('123311','124033','118376','124524'),0.1,rp_service_user_sale_fp_rate) as rp_service_user_sale_fp_rate,
	if(customer_no in ('123311','124033','118376','124524'),0.2,rp_service_user_profit_fp_rate) as rp_service_user_profit_fp_rate,
	if(customer_no in ('123311','124033','118376','124524'),0.1,fl_service_user_sale_fp_rate) as fl_service_user_sale_fp_rate,
	if(customer_no in ('123311','124033','118376','124524'),0.2,fl_service_user_profit_fp_rate) as fl_service_user_profit_fp_rate,
	if(customer_no in ('123311','124033','118376','124524'),0.1,bbc_service_user_sale_fp_rate) as bbc_service_user_sale_fp_rate,     
	if(customer_no in ('123311','124033','118376','124524'),0.2,bbc_service_user_profit_fp_rate) as bbc_service_user_profit_fp_rate,
	is_sale,is_overdue
from 
	csx_tmp.tc_customer_service_manager_info_new_20220423
where 
	province_name not in('福建省','安徽省')
...
from	
	...
	where
		...
		--202203月签 剔除逾期 每月
		and customer_no not in ('120314','120426')
		--202203月签呈，剔除逾期 每月
		...
		and customer_no not in ('104192','123395','117927','126154','111120')
