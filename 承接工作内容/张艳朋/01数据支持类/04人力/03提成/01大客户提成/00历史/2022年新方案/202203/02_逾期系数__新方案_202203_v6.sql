...
select 
	distinct province_name,customer_id,customer_no,customer_name,
	case when customer_no in ('123311','124033','118376','124524') then '1000000567740' 
		when customer_no in ('125486') then '1000000565688' else sales_id end as sales_id,
	case when customer_no in ('123311','124033','118376','124524') then '81103065' 
		when customer_no in ('125486') then '81090212' else work_no end as work_no,
	case when customer_no in ('123311','124033','118376','124524') then '王世超' 
		when customer_no in ('125486') then '周恩豪' else sales_name end as sales_name,
	case when customer_no in ('118376','123311') then '1000000567737' 
		when customer_no in ('124033') then '1000000211352' 
		when customer_no in ('118610','120260') then '1000000568032'
		when customer_no in ('124524','105552','111560','124546','115221','115883','125608','126018','126031') then null else rp_service_user_id end as rp_service_user_id,
	case when customer_no in ('118376','123311') then '81103328' 
		when customer_no in ('124033') then '81020509' 
		when customer_no in ('118610','120260') then '81103503'
		when customer_no in ('124524','105552','111560','124546','115221','115883','125608','126018','126031') then null else rp_service_user_work_no end as rp_service_user_work_no,		
	case when customer_no in ('118376','123311') then '武艳' 
		when customer_no in ('124033') then '陈素彩' 
		when customer_no in ('118610','120260') then '张孝阳'
		when customer_no in ('124524','105552','111560','124546','115221','115883','125608','126018','126031') then null else rp_service_user_name end as rp_service_user_name,
	case when customer_no in ('105552','111560','124546','105641','105786','119539','120428','120430','105891','106730') then null else fl_service_user_id end as fl_service_user_id,
	case when customer_no in ('105552','111560','124546','105641','105786','119539','120428','120430','105891','106730') then null else fl_service_user_work_no end as fl_service_user_work_no,
	case when customer_no in ('105552','111560','124546','105641','105786','119539','120428','120430','105891','106730') then null else fl_service_user_name end as fl_service_user_name,
	
	case when customer_no in ('118610') then '1000000568032' else bbc_service_user_id end as bbc_service_user_id,	
	case when customer_no in ('118610') then '81103503' else bbc_service_user_work_no end as bbc_service_user_work_no,
	case when customer_no in ('118610') then '张孝阳' else bbc_service_user_name end as bbc_service_user_name,	
	
	case when customer_no in ('123311','124033','118376','124524') then 0.9 
		when customer_no in ('105552','111560','124546','115221','115883','125608','126018','126031') then 1 else rp_sales_sale_fp_rate end as rp_sales_sale_fp_rate,
	case when customer_no in ('123311','124033','118376','124524') then 0.8 
		when customer_no in ('105552','111560','124546','115221','115883','125608','126018','126031') then 1 else rp_sales_profit_fp_rate end as rp_sales_profit_fp_rate,
	case when customer_no in ('123311','124033','118376','124524') then 0.9 
		when customer_no in ('105552','111560','124546','115221','115883','105641','105786','105891','106730','119539','120428','120430') then 1 else fl_sales_sale_fp_rate end as fl_sales_sale_fp_rate,
	case when customer_no in ('123311','124033','118376','124524') then 0.8 
		when customer_no in ('105552','111560','124546','115221','115883','105641','105786','105891','106730','119539','120428','120430') then 1 else fl_sales_profit_fp_rate end as fl_sales_profit_fp_rate,
	case when customer_no in ('123311','124033','118376','124524') then 0.9 
		when customer_no in ('105552','111560','124546','115221','115883') then 1 else bbc_sales_sale_fp_rate end as bbc_sales_sale_fp_rate,
	case when customer_no in ('123311','124033','118376','124524') then 0.8 
		when customer_no in ('105552','111560','124546','115221','115883') then 1 else bbc_sales_profit_fp_rate end as bbc_sales_profit_fp_rate,
	case when customer_no in ('123311','124033','118376','124524') then 0.1
		when customer_no in ('105552','111560','124546','115221','115883','125608','126018','126031') then 0 
		when customer_no in ('116639','117304','117605','118824','118848','119196','120985','121368') then 1 else rp_service_user_sale_fp_rate end as rp_service_user_sale_fp_rate,
	case when customer_no in ('123311','124033','118376','124524') then 0.2 
		when customer_no in ('105552','111560','124546','115221','115883','125608','126018','126031') then 0 
		when customer_no in ('116639','117304','117605','118824','118848','119196','120985','121368') then 1 else rp_service_user_profit_fp_rate end as rp_service_user_profit_fp_rate,
	case when customer_no in ('123311','124033','118376','124524') then 0.1 
		when customer_no in ('105552','111560','124546','115221','115883','105891','106730') then 0 else fl_service_user_sale_fp_rate end as fl_service_user_sale_fp_rate,
	case when customer_no in ('123311','124033','118376','124524') then 0.2 
		when customer_no in ('105552','111560','124546','115221','115883','105891','106730') then 0 else fl_service_user_profit_fp_rate end as fl_service_user_profit_fp_rate,
	case when customer_no in ('123311','124033','118376','124524') then 0.1 
		when customer_no in ('105552','111560','124546','115221','115883') then 0 else bbc_service_user_sale_fp_rate end as bbc_service_user_sale_fp_rate,     
	case when customer_no in ('123311','124033','118376','124524') then 0.2 
		when customer_no in ('105552','111560','124546','115221','115883') then 0 else bbc_service_user_profit_fp_rate end as bbc_service_user_profit_fp_rate,
	is_sale,is_overdue
from 
	csx_tmp.tc_customer_service_manager_info_new_20220423
where 
	province_name not in('福建省','安徽省','贵州省')
...
select 
	...
	is_sale,is_overdue
from 
	csx_tmp.tc_customer_service_manager_info_new_20220418
where 
	province_name in('贵州省')
; --5
