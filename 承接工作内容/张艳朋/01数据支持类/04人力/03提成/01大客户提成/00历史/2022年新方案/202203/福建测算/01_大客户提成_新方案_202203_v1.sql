...
from 
	...
	--202201月签呈，每月
	--重庆市
	union all select '105569' as customer_no,'202203' as smonth,0 as customer_sales_value, 0 as customer_ripei_sales_value,0 as customer_bbc_sales_value,0 as customer_fuli_sales_value,
	-10000.00 as customer_profit,-10000.00 as customer_ripei_profit, 0.00 as customer_bbc_profit, 0.00 as customer_fuli_profit
	--四川省，每月
	union all select '124403' as customer_no,'202203' as smonth,0 as customer_sales_value, 0 as customer_ripei_sales_value,0 as customer_bbc_sales_value,0 as customer_fuli_sales_value,
		-6300.00 as customer_profit,-6300.00 as customer_ripei_profit, 0.00 as customer_bbc_profit, 0.00 as customer_fuli_profit
	union all select '108835' as customer_no,'202203' as smonth,0 as customer_sales_value, 0 as customer_ripei_sales_value,0 as customer_bbc_sales_value,0 as customer_fuli_sales_value,
...
--客户提成详情
drop table csx_tmp.tc_new_cust_salary_202203; --17
create table csx_tmp.tc_new_cust_salary_202203
as
select
	a.smonth,
	--客户地区信息
...
from
	csx_tmp.tc_new_cust_salary_202203
;--19
...
from 
	csx_tmp.tc_new_cust_salary_202203 a 
group by 
