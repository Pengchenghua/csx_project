...
select 
	...
	--更改服务管家 当月
	case when customer_no in ('113096','115302','105908','121088') then '1000000562403' 
		when customer_no in ('107126','121667') then '1000000566086' 
		when customer_no in ('119539','120430','120428','105786','105849','105641','105757','107204','105741') then null 
		when customer_no in ('124546','125553','111560','105552') then null 
		when customer_no in ('105667','121449','115883','114777','124512','117034','117048','105807','106523','121220','117080','113733','113754','117071','113781','116218','113753') then null else rp_service_user_id_new end as rp_service_user_id,
	case when customer_no in ('113096','115302','105908','121088') then '81052035' 
		when customer_no in ('107126','121667') then '81095268' 
		when customer_no in ('119539','120430','120428','105786','105849','105641','105757','107204','105741') then null 
		when customer_no in ('124546','125553','111560','105552') then null 
		when customer_no in ('105667','121449','115883','114777','124512','117034','117048','105807','106523','121220','117080','113733','113754','117071','113781','116218','113753') then null else rp_service_user_work_no_new end as rp_service_user_work_no,		
	case when customer_no in ('113096','115302','105908','121088') then '袁成臣' 
		when customer_no in ('107126','121667') then '黄益聪' 
		when customer_no in ('119539','120430','120428','105786','105849','105641','105757','107204','105741') then null 
		when customer_no in ('124546','125553','111560','105552') then null 
		when customer_no in ('105667','121449','115883','114777','124512','117034','117048','105807','106523','121220','117080','113733','113754','117071','113781','116218','113753') then null else rp_service_user_name_new end as rp_service_user_name,
	
	case when customer_no in ('119539','120430','120428','105786','105849','105641','105757','107204','105741') then null 
		when customer_no in ('106730','105891','105870') then null 
		when customer_no in ('124546','125553','111560','105552') then null else fl_service_user_id_new end as fl_service_user_id,
	case when customer_no in ('119539','120430','120428','105786','105849','105641','105757','107204','105741') then null 
		when customer_no in ('106730','105891','105870') then null 
		when customer_no in ('124546','125553','111560','105552') then null else fl_service_user_work_no_new end as fl_service_user_work_no,
	case when customer_no in ('119539','120430','120428','105786','105849','105641','105757','107204','105741') then null 
		when customer_no in ('106730','105891','105870') then null 
		when customer_no in ('124546','125553','111560','105552') then null else fl_service_user_name_new end as fl_service_user_name,
	
	case when customer_no in ('119539','120430','120428','105786','105849','105641','105757','107204','105741') then null else bbc_service_user_id_new end as bbc_service_user_id,	
	case when customer_no in ('119539','120430','120428','105786','105849','105641','105757','107204','105741') then null else bbc_service_user_work_no_new end as bbc_service_user_work_no,
	case when customer_no in ('119539','120430','120428','105786','105849','105641','105757','107204','105741') then null else bbc_service_user_name_new end as bbc_service_user_name,	
	
	case when customer_no in ('123311','124033','118376','124524') then 0.9 
		when customer_no in ('113096','115302','105908','121088') then 0.7 
		when customer_no in ('126433','126517','126713','126765','126776','126894','126921') then 0.3
		when customer_no in ('119539','120430','120428','105786','105849','105641','105757','107204','105741') then 1 
		when customer_no in ('124546','125553','111560','105552') then 1 
		when customer_no in ('105667','121449','115883','114777','124512','117034','117048','105807','106523','121220','117080','113733','113754','117071','113781','116218','113753') then 1 else rp_sales_sale_rate end as rp_sales_sale_fp_rate,
	case when customer_no in ('123311','124033','118376','124524') then 0.8 
		when customer_no in ('113096','115302','105908','121088') then 0.5 
		when customer_no in ('126433','126517','126713','126765','126776','126894','126921') then 0.5
		when customer_no in ('119539','120430','120428','105786','105849','105641','105757','107204','105741') then 1 
		when customer_no in ('124546','125553','111560','105552') then 1 
		when customer_no in ('105667','121449','115883','114777','124512','117034','117048','105807','106523','121220','117080','113733','113754','117071','113781','116218','113753') then 1 else rp_sales_profit_rate end as rp_sales_profit_fp_rate,
		
	case when customer_no in ('123311','124033','118376','124524') then 0.9 
		when customer_no in ('119539','120430','120428','105786','105849','105641','105757','107204','105741') then 1 
		when customer_no in ('126433','126517','126713','126765','126776','126894','126921') then 0.3
		when customer_no in ('126433','126517','126713','126765','126776','126894','126921') then 0.3
		when customer_no in ('106730','105891','105870') then 1 
		when customer_no in ('124546','125553','111560','105552') then 1 else fl_sales_sale_rate end as fl_sales_sale_fp_rate,
	case when customer_no in ('123311','124033','118376','124524') then 0.8 
		when customer_no in ('119539','120430','120428','105786','105849','105641','105757','107204','105741') then 1 
		when customer_no in ('126433','126517','126713','126765','126776','126894','126921') then 0.5
		when customer_no in ('126433','126517','126713','126765','126776','126894','126921') then 0.5
		when customer_no in ('106730','105891','105870') then 1 
		when customer_no in ('124546','125553','111560','105552') then 1 else fl_sales_profit_rate end as fl_sales_profit_fp_rate,
	
	case when customer_no in ('123311','124033','118376','124524') then 0.9 
		when customer_no in ('126433','126517','126713','126765','126776','126894','126921') then 0.3
		when customer_no in ('119539','120430','120428','105786','105849','105641','105757','107204','105741') then 1 else bbc_sales_sale_rate end as bbc_sales_sale_fp_rate,
	case when customer_no in ('123311','124033','118376','124524') then 0.8 
		when customer_no in ('126433','126517','126713','126765','126776','126894','126921') then 0.5
		when customer_no in ('119539','120430','120428','105786','105849','105641','105757','107204','105741') then 1 else bbc_sales_profit_rate end as bbc_sales_profit_fp_rate,
	
	case when customer_no in ('123311','124033','118376','124524') then 0.1 
		when customer_no in ('113096','115302','105908','121088') then 0.3 else rp_service_user_sale_rate end as rp_service_user_sale_fp_rate,
	case when customer_no in ('123311','124033','118376','124524') then 0.2 
		when customer_no in ('113096','115302','105908','121088') then 0.5 else rp_service_user_profit_rate end as rp_service_user_profit_fp_rate,
		
	case when customer_no in ('123311','124033','118376','124524') then 0.1 else fl_service_user_sale_rate end as fl_service_user_sale_fp_rate,
	case when customer_no in ('123311','124033','118376','124524') then 0.2 else fl_service_user_profit_rate end as fl_service_user_profit_fp_rate,
	
	case when customer_no in ('123311','124033','118376','124524') then 0.1 else bbc_service_user_sale_rate end as bbc_service_user_sale_fp_rate,     
	case when customer_no in ('123311','124033','118376','124524') then 0.2 else bbc_service_user_profit_rate end as bbc_service_user_profit_fp_rate,
	is_sale,is_overdue
from 
	csx_tmp.report_crm_w_a_customer_service_manager_info_business_new
where 
...
from	
	...
	where
		...
		--202204月签呈 剔除逾期 当月
		and customer_no not in ('121332','115647','115888','122690','104901','126493','126659','126750','124484','117755','118326','121625','123244','124473','124217','125686','125029','124584','124784',
		'125017','125028','108102','124068','120376')
		--202204月签呈 剔除逾期 每月
