...
select 
	...
	case when customer_no in ('119539','120430','120428','105786','105849','105641','105757','107204','105741') then null 
		...
		when customer_no in ('124546','125553','111560','105552') then null 
		when customer_no in ('124658') then '1000000560749' else fl_service_user_id_new end as fl_service_user_id,
	case when customer_no in ('119539','120430','120428','105786','105849','105641','105757','107204','105741') then null 
		when customer_no in ('106730','105891','105870') then null 
		when customer_no in ('124546','125553','111560','105552') then null 
		when customer_no in ('124658') then '81034648' else fl_service_user_work_no_new end as fl_service_user_work_no,
	case when customer_no in ('119539','120430','120428','105786','105849','105641','105757','107204','105741') then null 
		when customer_no in ('106730','105891','105870') then null 
		when customer_no in ('124546','125553','111560','105552') then null 
		when customer_no in ('124658') then '李紫珊' else fl_service_user_name_new end as fl_service_user_name,
	...
	case when customer_no in ('123311','124033','118376','124524') then 0.9 
		...
		when customer_no in ('105667','121449','115883','114777','124512','117034','117048','105807','106523','121220','117080','113733','113754','117071','113781','116218','113753') then 1 
		--公司开发客户 按管家式提成 每月
		when customer_no in ('117762','124179') then 0.3 else rp_sales_sale_rate end as rp_sales_sale_fp_rate,
	case when customer_no in ('123311','124033','118376','124524') then 0.8 
		...
		when customer_no in ('105667','121449','115883','114777','124512','117034','117048','105807','106523','121220','117080','113733','113754','117071','113781','116218','113753') then 1 
		--公司开发客户 按管家式提成 每月
		when customer_no in ('117762','124179') then 0.5 else rp_sales_profit_rate end as rp_sales_profit_fp_rate,
	...
	case when customer_no in ('123311','124033','118376','124524') then 0.1 
		when customer_no in ('113096','115302','105908','121088') then 0.3 
		-- 销售员转岗前开发 按销售员算 每月
		when customer_no in ('116639','117304','117605','118824','120985') then 1 else rp_service_user_sale_rate end as rp_service_user_sale_fp_rate,
	case when customer_no in ('123311','124033','118376','124524') then 0.2 
		when customer_no in ('113096','115302','105908','121088') then 0.5
		-- 销售员转岗前开发 按销售员算 每月
		when customer_no in ('116639','117304','117605','118824','120985') then 1 else rp_service_user_profit_rate end as rp_service_user_profit_fp_rate,
		
	case when customer_no in ('123311','124033','118376','124524') then 0.1 
		when customer_no in ('124658') then 1 else fl_service_user_sale_rate end as fl_service_user_sale_fp_rate,
	case when customer_no in ('123311','124033','118376','124524') then 0.2 
		when customer_no in ('124658') then 1 else fl_service_user_profit_rate end as fl_service_user_profit_fp_rate,
...
from	
	...
	where
		...
		and customer_no not in ('120459','121206','102524','111204')	
