...
select 
	...
	--
	case when customer_no in ('') then null else rp_service_user_id_new end as rp_service_user_id,
	case when customer_no in ('') then null else rp_service_user_work_no_new end as rp_service_user_work_no,		
	case when customer_no in ('') then null else rp_service_user_name_new end as rp_service_user_name,
	
	case when customer_no in ('') then null else fl_service_user_id_new end as fl_service_user_id,
	case when customer_no in ('') then null else fl_service_user_work_no_new end as fl_service_user_work_no,
	case when customer_no in ('') then null else fl_service_user_name_new end as fl_service_user_name,
	
	case when customer_no in ('') then null else bbc_service_user_id_new end as bbc_service_user_id,	
	case when customer_no in ('') then null else bbc_service_user_work_no_new end as bbc_service_user_work_no,
	case when customer_no in ('') then null else bbc_service_user_name_new end as bbc_service_user_name,	
	--公司开发客户 按管家式提成 每月
	case when customer_no in ('117762','124179') then 0.3 else rp_sales_sale_rate end as rp_sales_sale_fp_rate,
	--公司开发客户 按管家式提成 每月
	case when customer_no in ('117762','124179') then 0.5 else rp_sales_profit_rate end as rp_sales_profit_fp_rate,
	...
	case when customer_no in ('') then 0.1 else fl_service_user_sale_rate end as fl_service_user_sale_fp_rate,
	case when customer_no in ('') then 0.2 else fl_service_user_profit_rate end as fl_service_user_profit_fp_rate,
	
	case when customer_no in ('') then 0.1 else bbc_service_user_sale_rate end as bbc_service_user_sale_fp_rate,     
	case when customer_no in ('') then 0.2 else bbc_service_user_profit_rate end as bbc_service_user_profit_fp_rate,
	is_sale,is_overdue
from 
	csx_tmp.report_crm_w_a_customer_service_manager_info_business_new
where 
