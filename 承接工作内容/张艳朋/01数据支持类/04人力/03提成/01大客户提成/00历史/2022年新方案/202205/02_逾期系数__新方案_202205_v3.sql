...
select 
	...
	--
	case when customer_no in ('105667','105807','106523','113733','113753','113754','113781','114777','115883','116218','117034','117048','117071','117080','121220','124512',
	'127249','127265','105641','105786','105849','119539','120428','120430','123569','123750','124281','125952','126021','105552','111560','124546','125553')
		then null else rp_service_user_id_new end as rp_service_user_id,
	case when customer_no in ('105667','105807','106523','113733','113753','113754','113781','114777','115883','116218','117034','117048','117071','117080','121220','124512',
	'127249','127265','105641','105786','105849','119539','120428','120430','123569','123750','124281','125952','126021','105552','111560','124546','125553')
		then null else rp_service_user_work_no_new end as rp_service_user_work_no,		
	case when customer_no in ('105667','105807','106523','113733','113753','113754','113781','114777','115883','116218','117034','117048','117071','117080','121220','124512',
	'127249','127265','105641','105786','105849','119539','120428','120430','123569','123750','124281','125952','126021','105552','111560','124546','125553') 
		then null else rp_service_user_name_new end as rp_service_user_name,
	--当月
	case when customer_no in ('110807') then '1000000560749'
		when customer_no in ('126943') then '1000000569181'	else fl_service_user_id_new end as fl_service_user_id,
	case when customer_no in ('110807') then '81034648' 
		when customer_no in ('126943') then '81122116' else fl_service_user_work_no_new end as fl_service_user_work_no,
	case when customer_no in ('110807') then '李紫珊' 
		when customer_no in ('126943') then '陈滨滨' else fl_service_user_name_new end as fl_service_user_name,
	
	case when customer_no in ('126943') then '1000000569181' else bbc_service_user_id_new end as bbc_service_user_id,	
	case when customer_no in ('126943') then '81122116' else bbc_service_user_work_no_new end as bbc_service_user_work_no,
	case when customer_no in ('126943') then '陈滨滨' else bbc_service_user_name_new end as bbc_service_user_name,	
	--公司开发客户 按管家式提成 每月
	case when customer_no in ('117762','124179') then 0.3 
		--202205月签呈 当月
		when customer_no in ('105667','105807','106523','113733','113753','113754','113781','114777','115883','116218','117034','117048','117071','117080','121220','124512',
		'127249','127265','105641','105786','105849','119539','120428','120430','123569','123750','124281','125952','126021','105552','111560','124546','125553') then 1
	...
	-- 销售员转岗前开发 按销售员算 每月
	case when customer_no in ('116639','117304','117605','118824','120985') then 1 else rp_service_user_sale_rate end as rp_service_user_sale_fp_rate,
	-- 销售员转岗前开发 按销售员算 每月
	case when customer_no in ('116639','117304','117605','118824','120985') then 1 else rp_service_user_profit_rate end as rp_service_user_profit_fp_rate,
	--当月
	case when customer_no in ('110807','126943') then 1 else fl_service_user_sale_rate end as fl_service_user_sale_fp_rate,
	case when customer_no in ('110807','126943') then 1 else fl_service_user_profit_rate end as fl_service_user_profit_fp_rate,
	--当月
	case when customer_no in ('126943') then 1 else bbc_service_user_sale_rate end as bbc_service_user_sale_fp_rate,     
	case when customer_no in ('126943') then 1 else bbc_service_user_profit_rate end as bbc_service_user_profit_fp_rate,
	is_sale,is_overdue
from 
	csx_tmp.report_crm_w_a_customer_service_manager_info_business_new
where 
