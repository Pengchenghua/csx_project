...
select 
	...
	a.rp_sales_value*if(a.customer_no in ('127923','126690'),0.002,coalesce(f.sales_rp_bbc_sales_value_tc_rate,0.002)) as salary_rp_sales_value, -- 奖金包_日配销售额
	...
	'124401','124416','119760','121841','125767','127262','114859','115681','115941','120872','120879','121287','125722','120768','121384','124351','127954') then 0.02
		--'127923' 销售额*0.2% 不计算毛利提成 每月
		--'126690' 销售额*0.2% 不计算毛利提成 每月
		when a.customer_no in ('127923','126690') then 0
