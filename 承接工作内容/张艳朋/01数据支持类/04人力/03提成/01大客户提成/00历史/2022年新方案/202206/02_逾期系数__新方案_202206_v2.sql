...
select 
	...
	case when customer_no in ('117762','124179','126140','126408') then 0.3 
		...
		when customer_no in ('124524','126690','123760','125550','127477','127803','127965') then 1	
	...
	case when customer_no in ('') then 0.9 when customer_no in ('127477','127803','127965') then 1 else fl_sales_sale_rate end as fl_sales_sale_fp_rate,
	case when customer_no in ('') then 0.8 when customer_no in ('127477','127803','127965') then 1 else fl_sales_profit_rate end as fl_sales_profit_fp_rate,
	
	case when customer_no in ('') then 0.9 when customer_no in ('127477','127803','127965') then 1 else bbc_sales_sale_rate end as bbc_sales_sale_fp_rate,
	case when customer_no in ('') then 0.8 when customer_no in ('127477','127803','127965') then 1 else bbc_sales_profit_rate end as bbc_sales_profit_fp_rate,
	-- 销售员转岗前开发 按销售员算 每月
