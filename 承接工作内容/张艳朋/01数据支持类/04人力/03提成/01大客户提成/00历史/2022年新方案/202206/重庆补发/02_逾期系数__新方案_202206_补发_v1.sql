...
select 
	...
	case when customer_no in ('123311','124033','118376','124524') then '1000000567740' 
		...
		when customer_no in ('127965') then '1000000572833' else sales_id_new end as sales_id,
	case when customer_no in ('123311','124033','118376','124524') then '81103065' 
		...
		when customer_no in ('127965') then '81146049' else work_no_new end as work_no,
	case when customer_no in ('123311','124033','118376','124524') then '王世超' 
		...
		when customer_no in ('127965') then '张鹏' else sales_name_new end as sales_name,
	--
	case when customer_no in ('105754','106247','107337','113501','116639','116932','120830','122837','125028','127249','127265','111560','123569','123750','124281','126124')then null 
		--每月
		when customer_no in ('124524','126690','127477','127803','127965','123760','125550') then null
	...
	case when customer_no in ('117762','124179','126140','126408','105754','106247','107337','113501','127553','127737','127756','127860','127719','113724','113749') then 0.3 
		...
		when customer_no in ('124524','126690','123760','125550','127477','127803','127965','127923') then 1	
...
from	
	...
	left join 
		...
		where 
			...
			and customer_no not in('123244','127923','126690','115941','120768','114853','124351','121020','121384','121337','124558','124193','120872','113829','111881',
			'115904','114859','112410','125719','127954','120879','125722','112948','121287'
				)
