...
select 
	...
	case when customer_no in ('123311','124033','118376','124524') then '1000000567740' 
		when customer_no in ('127649') then '1000000579405' 
		when customer_no in ('126690') then '1000000064109' 
		when customer_no in ('123760','125550') then '1000000559072' 
		when customer_no in ('127477','127803') then '1000000569580' 
		when customer_no in ('127923') then '1000000562261' 
		when customer_no in ('127965') then '1000000572833' 
		when customer_no in ('126024','127924','128183') then '1000000572833' else sales_id_new end as sales_id,
	case when customer_no in ('123311','124033','118376','124524') then '81103065' 
		when customer_no in ('127649') then '50000068' 
		when customer_no in ('126690') then '80895349' 
		when customer_no in ('123760','125550') then '81025317' 
		when customer_no in ('127477','127803') then '81126241' 
		when customer_no in ('127923') then '81049516' 
		when customer_no in ('127965') then '81146049' 
		when customer_no in ('126024','127924','128183') then '81146049' else work_no_new end as work_no,
	case when customer_no in ('123311','124033','118376','124524') then '王世超' 
		when customer_no in ('127649') then '王一红' 
		when customer_no in ('126690') then '陈扬平' 
		when customer_no in ('123760','125550') then '池冬妮' 
		when customer_no in ('127477','127803') then '张红林' 
		when customer_no in ('127923') then '张文宝' 
		when customer_no in ('127965') then '张鹏' 
		when customer_no in ('126024','127924','128183') then '张鹏' else sales_name_new end as sales_name,
	--
	case when customer_no in ('105754','106247','107337','113501','116639','116932','120830','122837','125028','127249','127265','111560','123569','123750','124281','126124')then null 
		--每月
		when customer_no in ('126690','127477','127803','127965','123760','125550','126024','127924','128183') then null
		
		when customer_no in ('116639') then null
		
		--每月
		when customer_no in ('126259') then '1000000569580'
		--当月
		when customer_no in ('124524') then '1000000565117'
	...
	case when customer_no in ('105754','106247','107337','113501','116639','116932','120830','122837','125028','127249','127265','111560','123569','123750','124281','126124')then null
		...
		--每月
		when customer_no in ('126259') then '81126241'	
		--当月
		when customer_no in ('124524') then '81084752'		
	...
	case when customer_no in ('105754','106247','107337','113501','116639','116932','120830','122837','125028','127249','127265','111560','123569','123750','124281','126124')then null
		...
		--每月
		when customer_no in ('126259') then '张红林'
		--当月
		when customer_no in ('124524') then '张鹏'			
		else rp_service_user_name_new end as rp_service_user_name,
	--当月
	case when customer_no in ('') then '1000000560749'
		--每月
		when customer_no in ('124524','126690','127477','127803','127965') then null
	...
	case when customer_no in ('') then '1000000569181' when customer_no in ('123760','125550','127477','127803','127965') then null else bbc_service_user_id_new end as bbc_service_user_id,	
	case when customer_no in ('') then '81122116' when customer_no in ('123760','125550','127477','127803','127965') then null else bbc_service_user_work_no_new end as bbc_service_user_work_no,
	case when customer_no in ('') then '陈滨滨' when customer_no in ('123760','125550','127477','127803','127965') then null else bbc_service_user_name_new end as bbc_service_user_name,	
	--公司开发客户 按管家式提成 每月
	case when customer_no in ('117762','124179','126140','126408','105754','106247','107337','113501','127553','127737','127756','127860','127719','113724','113749','128191') then 0.3 
		--河南省 每月
		when customer_no in ('123311','124033','118376') then 0.9	
		when customer_no in ('124524','126690','123760','125550','127477','127803','127965','127923','126024','127924','128183') then 1	
		
		--202206月签呈 当月
		when customer_no in ('116639','105754','106247','107337','113501','116639','116932','120830','122837','125028','127249','127265','111560','123569','123750','124281','126124') then 1
		when customer_no in ('') then 0.7		
		else rp_sales_sale_rate end as rp_sales_sale_fp_rate,
	--公司开发客户 按管家式提成 每月
	case when customer_no in ('117762','124179','126140','126408','105754','106247','107337','113501','127553','127737','127756','127860','127719','113724','113749','128191') then 0.5 
		--河南省 每月
	...
	case when customer_no in ('105754','106247','107337','113501','127553','127737','127756','127860','127719','113724','113749') then 0.3 when customer_no in ('127477','127803','127965','123760','125550') then 1 else fl_sales_sale_rate end as fl_sales_sale_fp_rate,
	case when customer_no in ('105754','106247','107337','113501','127553','127737','127756','127860','127719','113724','113749') then 0.5 when customer_no in ('127477','127803','127965','123760','125550') then 1 else fl_sales_profit_rate end as fl_sales_profit_fp_rate,
	
	case when customer_no in ('105754','106247','107337','113501','127553','127737','127756','127860','127719','113724','113749') then 0.3 when customer_no in ('127477','127803','127965','123760','125550') then 1 else bbc_sales_sale_rate end as bbc_sales_sale_fp_rate,
	case when customer_no in ('105754','106247','107337','113501','127553','127737','127756','127860','127719','113724','113749') then 0.5 when customer_no in ('127477','127803','127965','123760','125550') then 1 else bbc_sales_profit_rate end as bbc_sales_profit_fp_rate,
	-- 销售员转岗前开发 按销售员算 每月
...
from	
	...
	where
		...
		--202207月签呈 剔除逾期 当月
		and customer_no not in ('125686','119175','125992','105523','106765','124270','126266','107956','121015','121468','123158','114567','122322','124085','104086','118117','126280','114799','121457','125223','125654','121781')		
	) a 
	--剔除业务代理与内购客户
	join		
		(
