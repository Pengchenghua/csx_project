...
from
	...
	left join		
		...
		from 
			(
			select 
				distinct customer_no,service_user_work_no,service_user_name,service_user_id
			from 
...
--ALTER TABLE csx_dw.report_crm_w_a_customer_service_manager_info_new ADD COLUMNS 
--(
--customer_id bigint COMMENT '客户id',
--sales_id bigint COMMENT '销售员id',
--service_user_id bigint COMMENT '服务管家id'
--);
