...
select 
	...
	a.rp_profit*if(a.customer_no in ('123685','116566','125360','123122','111832','111691','120723','115221','112906','118509','117817','121472','121994','124356','124367',
		'124387','124401','124416','119760','125767'),0.02,coalesce(e.sales_rp_bbc_profit_tc_rate,0.03)) as salary_rp_profit, --奖金包_日配定价毛利额
	--奖金包_福利业务
	...
	a.fl_profit*if(a.customer_no in ('123685','116566','125360','123122','111832','111691','120723','115221','112906','118509','117817','121472','121994','124356','124367',
		'124387','124401','124416','119760','125767'),0.02,coalesce(e.sales_fl_profit_tc_rate,0.02)) as salary_fl_profit, --奖金包_福利定价毛利额
	--奖金包_BBC业务
	...
	a.bbc_profit*if(a.customer_no in ('123685','116566','125360','123122','111832','111691','120723','115221','112906','118509','117817','121472','121994','124356','124367',
		'124387','124401','124416','119760','125767'),0.02,coalesce(e.sales_rp_bbc_profit_tc_rate,0.03)) as salary_bbc_profit, --奖金包_bbc定价毛利额	
...
--客户提成详情
drop table csx_tmp.tc_new_cust_salary_info; --17
create table csx_tmp.tc_new_cust_salary_info
as
select
	a.smonth,
	--客户地区信息
...
from
	csx_tmp.tc_new_cust_salary_info
;--19
...
from 
	csx_tmp.tc_new_cust_salary_info a 
group by 
