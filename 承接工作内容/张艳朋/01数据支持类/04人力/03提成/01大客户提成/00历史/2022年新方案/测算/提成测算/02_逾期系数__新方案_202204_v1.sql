...
select 
	distinct province_name,customer_id,customer_no,customer_name,
	case when customer_no in ('123311','124033','118376','124524') then '1000000567740' else sales_id end as sales_id,
	case when customer_no in ('123311','124033','118376','124524') then '81103065' else work_no end as work_no,
	case when customer_no in ('123311','124033','118376','124524') then '王世超' else sales_name end as sales_name,
	rp_service_user_id,
	...
	case when customer_no in ('123311','124033','118376','124524') then 0.9 else rp_sales_sale_rate end as rp_sales_sale_fp_rate,
	case when customer_no in ('123311','124033','118376','124524') then 0.8 else rp_sales_profit_rate end as rp_sales_profit_fp_rate,
	case when customer_no in ('123311','124033','118376','124524') then 0.9 else fl_sales_sale_rate end as fl_sales_sale_fp_rate,
	case when customer_no in ('123311','124033','118376','124524') then 0.8 else fl_sales_profit_rate end as fl_sales_profit_fp_rate,
	case when customer_no in ('123311','124033','118376','124524') then 0.9 else bbc_sales_sale_rate end as bbc_sales_sale_fp_rate,
	case when customer_no in ('123311','124033','118376','124524') then 0.8 else bbc_sales_profit_rate end as bbc_sales_profit_fp_rate,
	case when customer_no in ('123311','124033','118376','124524') then 0.1 else rp_service_user_sale_rate end as rp_service_user_sale_fp_rate,
	case when customer_no in ('123311','124033','118376','124524') then 0.2 else rp_service_user_profit_rate end as rp_service_user_profit_fp_rate,
