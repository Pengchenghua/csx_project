...
from
	...
	select 
		...
		customer_no,
		-- 各类型销售额
		sum(case when dc_code !='W0K4' then sales_value else 0 end) as customer_sales_value, 
...
--刷新数据
insert overwrite table csx_dw.report_sss_r_d_crm_sales_sale_trend_new partition(sdt)
select
