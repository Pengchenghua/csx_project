...
from
	...
	select 
		...
		case when work_no in ('80886641','81133185','81107924','80897767','81034712','81087574','81095700') then '淮南'
			when work_no in ('80884343','81138992','80972242','81054801','81123285','81119588','81138989','81086805') then '阜阳'
...
from
	...
	group by 
		--channel_name,
		customer_no,customer_name,company_code,company_name
	)a	
group by 
	--channel_name,
...
select
	...
	a.excluding_tax_sales,a.excluding_tax_profit,a.profit_rate,a.sales_cost,b.over_amt_s,b.receivable_amount_s,b.over_rate
from
	(
	select 
		a.s_month,a.region_name,a.province_name,b.sales_person_cityname,
	...
	left join
		(
		select
			sales_person_cityname,over_amt_s,receivable_amount_s,over_rate
		from
