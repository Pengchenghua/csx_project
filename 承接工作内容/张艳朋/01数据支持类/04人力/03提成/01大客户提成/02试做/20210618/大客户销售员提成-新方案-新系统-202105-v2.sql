...
--drop table csx_tmp.tmp_salesname_rate_ytd_v2;
create table if not exists csx_tmp.tmp_salesname_rate_ytd_v2
as
select 
...
drop table csx_tmp.temp_new_cust_00_v2;
create table csx_tmp.temp_new_cust_00_v2
as
select 
	b.sales_province_name dist,a.customer_no cust_id,b.customer_name cust_name,d.work_no,d.sales_name,d.is_part_time_service_manager,d.service_user_work_no,d.service_user_name,
	d.sales_sale_rate,d.sales_front_profit_rate,d.service_user_sale_rate,d.service_user_front_profit_rate,a.smonth,
...
--★★★合并返利新增  		
	...
	left join 
		...
		from 
			csx_tmp.tmp_salesname_rate_ytd_v2 where sdt>=${hiveconf:i_sdate_12} and sdt<=${hiveconf:i_sdate_11}  --上月1日，昨日月1日
		group by 
	...
	left join		
		(  
		select 
			customer_no,is_part_time_service_manager,service_user_work_no,service_user_name,sales_sale_rate,sales_front_profit_rate,service_user_sale_rate,service_user_front_profit_rate,
			work_no,sales_name
		from 
...
where 
	...
	and b.ng_cust is null
group by 
	b.sales_province_name,a.customer_no,b.customer_name,d.work_no,d.sales_name,d.is_part_time_service_manager,d.service_user_work_no,d.service_user_name,
	d.sales_sale_rate,d.sales_front_profit_rate,d.service_user_sale_rate,d.service_user_front_profit_rate,a.smonth,c.sale_rate,c.profit_rate;



--大客户前端毛利扣点后结果
drop table csx_tmp.temp_new_cust_01_v2;
create table csx_tmp.temp_new_cust_01_v2
as
select 
	a.dist,a.cust_id,a.cust_name,a.work_no,a.sales_name,is_part_time_service_manager,service_user_work_no,service_user_name,sales_sale_rate,sales_front_profit_rate,service_user_sale_rate,service_user_front_profit_rate,a.smonth,
...
drop table csx_tmp.temp_new_cust_salary_v2;
create table csx_tmp.temp_new_cust_salary_v2
as
select 
...
from  
	csx_tmp.temp_new_cust_01_v2 a
	left join csx_tmp.temp_cust_over_rate_v2 b on b.customer_no=a.cust_id
	left join csx_tmp.temp_salesname_over_rate_v2 c on c.sales_name=a.sales_name and coalesce(c.work_no,0)=coalesce(a.work_no,0)
	left join csx_tmp.temp_service_user_over_rate_v2 d on d.service_user_name=a.service_user_name and coalesce(d.service_user_work_no,0)=coalesce(a.service_user_work_no,0)
...
from 
	csx_tmp.temp_new_cust_salary_v2;
