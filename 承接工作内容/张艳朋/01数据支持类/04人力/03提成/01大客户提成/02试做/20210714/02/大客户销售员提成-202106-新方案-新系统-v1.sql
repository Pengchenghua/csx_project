...
left join 
	...
	from csx_tmp.tmp_tc_salesname_rate_ytd where sdt>=${hiveconf:i_sdate_12} and sdt<=${hiveconf:i_sdate_11}  --上月1日，昨日月1日
...
--大客户前端毛利扣点后结果
drop table csx_tmp.temp_tc_new_cust_01;
...
from csx_tmp.temp_tc_new_cust_00 a
left join
(  --福建区域大客户扣点 20200115
...
from csx_tmp.temp_tc_new_cust_01;
...
drop table csx_tmp.temp_tc_new_cust_salary;
...
from  
  (select * from csx_tmp.temp_tc_new_cust_03
...
from csx_tmp.temp_tc_new_cust_salary;
