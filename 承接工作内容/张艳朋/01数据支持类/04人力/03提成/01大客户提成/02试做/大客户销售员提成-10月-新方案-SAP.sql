...
--load data inpath '/tmp/raoyanhua/sales_income_info_8.csv' overwrite into table csx_tmp.sales_income_info partition (sdt='20200831');
--select * from csx_tmp.sales_income_info where sdt='20200831';
...
left join (select * from csx_dw.dws_crm_w_a_customer_m_v1 where sdt='20200831') b on b.customer_no=a.customer_no
left join (select distinct work_no,income_type from csx_tmp.sales_income_info where sdt='20200731') c on c.work_no=b.work_no
