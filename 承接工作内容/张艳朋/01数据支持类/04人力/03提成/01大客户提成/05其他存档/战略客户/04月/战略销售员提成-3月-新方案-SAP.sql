...
--load data inpath '/tmp/raoyanhua/strategic_cust_info_03.csv' overwrite into table csx_tmp.strategic_cust_info_new partition (sdt='202103');
--select * from csx_tmp.strategic_cust_info_new where sdt='202103';
