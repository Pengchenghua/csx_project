...
--load data inpath '/tmp/raoyanhua/strategic_cust_info_04.csv' overwrite into table csx_tmp.strategic_cust_info_new partition (sdt='202104');
--select * from csx_tmp.strategic_cust_info_new where sdt='202104';
