...
--load data inpath '/tmp/zhangyanpeng/strategic_cust_info_10.csv' overwrite into table csx_tmp.strategic_cust_info_new partition (sdt='202110');
--select * from csx_tmp.strategic_cust_info_new where sdt='202110';
