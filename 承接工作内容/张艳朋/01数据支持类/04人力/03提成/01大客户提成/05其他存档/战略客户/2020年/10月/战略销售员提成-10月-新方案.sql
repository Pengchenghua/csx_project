...
--load data inpath '/tmp/raoyanhua/strategic_cust_info_10.csv' overwrite into table csx_tmp.strategic_cust_info_new partition (sdt='202010');
--select * from csx_tmp.strategic_cust_info_new where sdt='202010';
...
set i_sdate_11 ='20201031';
set i_sdate_12 ='20201101';
	
set i_sdate_22 ='20201001';				
