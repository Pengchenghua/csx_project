...
--load data inpath '/tmp/raoyanhua/strategic_cust_info_8.csv' overwrite into table csx_tmp.strategic_cust_info_new partition (sdt='202008');
--select * from csx_tmp.strategic_cust_info_new where sdt='202008';
