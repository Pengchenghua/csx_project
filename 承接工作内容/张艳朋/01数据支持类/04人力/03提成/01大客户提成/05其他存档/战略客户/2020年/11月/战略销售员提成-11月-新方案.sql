...
--load data inpath '/tmp/raoyanhua/strategic_cust_info_11.csv' overwrite into table csx_tmp.strategic_cust_info_new partition (sdt='202011');
--select * from csx_tmp.strategic_cust_info_new where sdt='202011';
