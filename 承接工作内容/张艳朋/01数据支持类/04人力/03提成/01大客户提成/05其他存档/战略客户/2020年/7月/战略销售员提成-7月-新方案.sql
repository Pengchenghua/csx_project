...
--load data inpath '/tmp/raoyanhua/strategic_cust_info_7.csv' overwrite into table csx_tmp.strategic_cust_info_new partition (sdt='202007');
--select * from csx_tmp.strategic_cust_info_new where sdt='202007';
...
--left join (select * from csx_dw.dws_crm_w_a_customer_m_v1 where sdt=${hiveconf:i_sdate_23}) b on b.customer_no=a.customer_no
