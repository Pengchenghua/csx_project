...
b.over_rate,
--if(a.salary<0 or b.over_rate is null,a.salary,a.salary*(1-coalesce(if(b.over_rate<=0.5,b.over_rate,1),0)) ) salary_2
--if(z.salary3 is null,if(a.salary<0 or b.over_rate is null,a.salary,a.salary*(1-coalesce(if(b.over_rate<=0.5,b.over_rate,1),0)) ),z.salary3) salary_2
