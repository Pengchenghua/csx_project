...
from
	...
	select 
		...
		case when customer_no in ('124803','122697','125547','125741','125736','125738','125763','112291','125757') then '福清'
			when customer_no in ('125508','122125','120100','119703','115721') then '永安'
			when customer_no in ('122327','122338','123213') then '长乐'
		end as sales_person_cityname
	from 
		csx_dw.dws_crm_w_a_customer
	where 
		sdt = ${hiveconf:i_sdate_11} 
		and customer_no in ('124803','122697','125547','125741','125736','125738','125763','112291','125757','125508','122125','120100','119703','115721','122327','122338','123213')
	) a 
where
