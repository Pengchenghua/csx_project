...
from
	...
	select 
		...
		case when customer_code in ('125741','125547','125763','125739') then '福清'
			when customer_code in ('128799','128836','128845','128849','128841','128759','128844','128818','128840','128835') then '宁德'
			when customer_code in ('129797') then '泉州'
			when customer_code in ('127566','128906','122328','122327','123213','127573','126178','128157','124198','124225','126187') then '长乐'
	...
	where 
		sdt = '20230131' 
		and customer_code in ('125741','125547','125763','125739','128799','128836','128845','128849','128841','128759','128844','128818','128840','128835','129797','127566',
		'128906','122328','122327','123213','127573','126178','128157','124198','124225','126187'
		)
	) a 
where
...
from
	...
	where 
		sdt = '20230131' --and channel_name = '大客户' 
	)a
	join		 
		(
		select 
