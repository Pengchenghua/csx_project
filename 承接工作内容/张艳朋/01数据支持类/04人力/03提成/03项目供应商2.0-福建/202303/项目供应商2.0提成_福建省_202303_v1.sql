...
from
	...
	select 
		...
		case when customer_code in ('125763','112291','125741','129722','124803','125739','125547') then '福清'
			when customer_code in ('128844','128836','128845','128799','128849','128835','128818','128840','128759','128841') then '宁德'
			when customer_code in ('123242','131457','123253','122269','129797','128724','130114','123247','130784') then '泉州'
			when customer_code in ('129984','124198','122338','122339','126187','223729','128157','128906','124225','127573','122327','123213','122328','126178') then '长乐'
	...
	where 
		sdt = '20230331' 
		and customer_code in ('125763','112291','125741','129722','124803','125739','125547','128844','128836','128845','128799','128849','128835','128818','128840','128759',
		'128841','123242','131457','123253','122269','129797','128724','130114','123247','130784','129984','124198','122338','122339','126187','223729','128157','128906',
		'124225','127573','122327','123213','122328','126178'
		)
	) a 
where
...
from
	...
	where 
		sdt = '20230331' --and channel_name = '大客户' 
	)a
	join		 
		(
		select 
...
from
	...
	select
		...
		if((sign_company_code='2121' and profit_rate<0.08) or profit_rate<0.07,0,sale_amt_no_tax) as sale_amt_no_tax, 
		if((sign_company_code='2121' and profit_rate<0.08) or profit_rate<0.07,0,profit_no_tax) as profit_no_tax, 
		sale_cost,
		if((sign_company_code='2121' and profit_rate<0.08) or profit_rate<0.07,0,profit_rate) as profit_rate
	from
		(
		select 
