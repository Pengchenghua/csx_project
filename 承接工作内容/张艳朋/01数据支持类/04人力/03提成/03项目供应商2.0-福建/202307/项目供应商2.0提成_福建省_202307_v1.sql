...
from
	...
	select 
		...
		case when customer_code in ('129722','125763','125736','125739') then '福清'
			when customer_code in ('128841','128835','128836','128849','128840','128799','128844','128818','222771') then '宁德'
			when customer_code in ('131457','128724','123242','131497','123253','130114','123247','122269','129797','130784') then '泉州'
			when customer_code in ('129984','123213','122328','122327','126178','128906','169137','230328','128157','127573','124198','126187','124225','122339') then '长乐'
	...
	where 
		sdt = '20230731' 
		and customer_code in ('129722','125763','125736','125739','128841','128835','128836','128849','128840','128799','128844','128818','222771','131457','128724',
		'123242','131497','123253','130114','123247','122269','129797','130784','129984','123213','122328','122327','126178','128906','169137','230328','128157','127573',
		'124198','126187','124225','122339'
		)
	) a 
where
...
from
	...
	where 
		sdt = '20230731' --and channel_name = '大客户' 
	)a
	join		 
		(
		select 
