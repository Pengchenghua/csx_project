...
from
	...
	select 
		...
		case when customer_code in ('125763','125739','125736') then '福清'
			when customer_code in ('128849','128818','128799','222771','128844','128836') then '宁德'
			when customer_code in ('131497','129797','130784','131457') then '泉州'
			when customer_code in ('128906','128157','169137','230328','126178','122327','124225','124198','123213','127573','126187') then '长乐'
		end as sales_person_cityname
	from 
		csx_dim.csx_dim_crm_customer_info
	where 
		sdt = '20230831' 
		and customer_code in ('125763','125739','125736','128849','128818','128799','222771','128844','128836','131497','129797','130784','131457','128906','128157',
		'169137','230328','126178','122327','124225','124198','123213','127573','126187'
		)
	) a 
where
...
from
	...
	where 
		sdt = '20230831' --and channel_name = '大客户' 
	)a
	join		 
		(
		select 
