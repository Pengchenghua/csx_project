...
set current_end_day ='20210831';

set last_month_start_day ='20210701';

set last_month_end_day ='20210731';
...
select
	...
	b.sales_city_name,
	coalesce(c.leader_code,'') as leader_code,
	coalesce(c.leader_name,'') as leader_name,
	a.work_no,
	a.sales_name,
...
group by 
	...
	b.sales_province_name,
	b.sales_city_name,
	coalesce(c.leader_code,''),
	coalesce(c.leader_name,''),
	a.work_no,
	a.sales_name,
