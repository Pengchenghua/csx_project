...
insert overwrite directory '/tmp/zhangyanpeng/20211012_13' row format delimited fields terminated by '\t'
...
insert overwrite directory '/tmp/zhangyanpeng/20211012_14' row format delimited fields terminated by '\t'
