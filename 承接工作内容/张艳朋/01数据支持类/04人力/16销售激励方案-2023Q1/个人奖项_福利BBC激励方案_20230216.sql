...
select
	concat('20230101-',regexp_replace(to_date(date_sub(current_date(),1)),'-','')) as sdt_s,
...
from 
	...
	where 
		sdt between '20230101' and regexp_replace(to_date(date_sub(current_date(),1)),'-','') -- '20221231'
