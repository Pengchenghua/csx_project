...
where 
	sdt between '20230901' and '20231031' -- regexp_replace(to_date(date_sub(current_date(),1)),'-','')
...
group by 
	performance_region_name,
	if(performance_province_name in ('上海松江','上海宝山'),'上海市',performance_province_name),
	customer_code,
	customer_name
;