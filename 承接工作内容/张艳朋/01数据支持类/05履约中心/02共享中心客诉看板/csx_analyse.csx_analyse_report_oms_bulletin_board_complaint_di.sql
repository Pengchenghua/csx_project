...
select
	...
	coalesce(regexp_replace(a.complaint_describe,'\n|\t|\r|\,|\"|\\\\n',''),'') as complaint_describe,
	...
	coalesce(regexp_replace(e.result,'\n|\t|\r|\,|\"|\\\\n',''),'') as result,
	...
	coalesce(regexp_replace(e.reason,'\n|\t|\r|\,|\"|\\\\n',''),'') as reason,
	coalesce(regexp_replace(e.plan,'\n|\t|\r|\,|\"|\\\\n',''),'') as plan,
	coalesce(d.classify_large_code,'') as classify_large_code,
	coalesce(d.classify_large_name,'') as classify_large_name,
	coalesce(d.classify_middle_code,'') as classify_middle_code,
	coalesce(d.classify_middle_name,'') as classify_middle_name,
	coalesce(d.classify_small_code,'') as classify_small_code,
	coalesce(d.classify_small_name,'') as classify_small_name
from
	(
	select
	...
	left join
		...
		select 
			...
			classify_middle_name,classify_small_code,classify_small_name,unit_name,standard,bar_code
		from 
...
--ALTER TABLE csx_tmp.report_oms_r_a_complaint_detail ADD COLUMNS 
--(
...
--ALTER TABLE csx_tmp.report_oms_r_a_complaint_detail DROP PARTITION(sdt='20220316')