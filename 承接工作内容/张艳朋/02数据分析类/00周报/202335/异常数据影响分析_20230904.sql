...
from 
	...
	from 
		csx_dws.csx_dws_sale_detail_di 
	where 
		((sdt>='20230701' and sdt<='20230731') or (sdt>='20230801' and sdt<='20230831'))
		and channel_code in('1','7','9')
		and business_type_code in (1) 
		and performance_region_name in ('华北大区')
	) a 
...
from 
	csx_dws.csx_dws_sale_detail_di 
where 
	sdt>='20230826' and sdt<='20230901'
	and channel_code in('1','7','9')
	and business_type_code in (1) 
	and performance_province_name in ('东北')
	and delivery_type_code=2
	and inventory_dc_code not in ('WB26')
