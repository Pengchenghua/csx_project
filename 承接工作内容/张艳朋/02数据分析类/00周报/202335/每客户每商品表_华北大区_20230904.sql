...
select
	...
	if(c.first_sales_date >= '20230801' and c.first_sales_date<= '20230831','新客','老客') as xinlaok,
	sum(case when a.sdt >= '20230801' and a.sdt <= '20230831' then a.sales_value end) by_sales_value,
	sum(case when a.sdt >= '20230801' and a.sdt <= '20230831' then a.sale_qty end) by_sale_qty,
	sum(case when a.sdt >= '20230801' and a.sdt <= '20230831' then a.profit end) by_profit,	
	sum(case when a.sdt >= '20230701' and a.sdt <= '20230731' then a.sales_value end) sy_sales_value,
	sum(case when a.sdt >= '20230701' and a.sdt <= '20230731' then a.sale_qty end) sy_sale_qty,
	sum(case when a.sdt >= '20230701' and a.sdt <= '20230731' then a.profit end) sy_profit,	
...
from 
	...
	from 
	    ...
	    where 
			sdt >= '20230701' and sdt <= regexp_replace(add_months(date_sub(current_date,1),0),'-','') 
...
group by 
	...
	if(c.first_sales_date >= '20230801' and c.first_sales_date<= '20230831','新客','老客')
having 
