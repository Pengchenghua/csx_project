...
select
	...
	if(c.first_sales_date >= '20231001' and c.first_sales_date<= '20231031','新客','老客') as xinlaok,
	sum(case when a.sdt >= '20231001' and a.sdt <= '20231031' then a.sales_value end) by_sales_value,
	sum(case when a.sdt >= '20231001' and a.sdt <= '20231031' then a.sale_qty end) by_sale_qty,
	sum(case when a.sdt >= '20231001' and a.sdt <= '20231031' then a.profit end) by_profit,	
	sum(case when a.sdt >= '20230901' and a.sdt <= '20230930' then a.sales_value end) sy_sales_value,
	sum(case when a.sdt >= '20230901' and a.sdt <= '20230930' then a.sale_qty end) sy_sale_qty,
	sum(case when a.sdt >= '20230901' and a.sdt <= '20230930' then a.profit end) sy_profit,	
...
group by 
	...
	if(c.first_sales_date >= '20231001' and c.first_sales_date<= '20231031','新客','老客')
having 
