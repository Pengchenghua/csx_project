-- ------------------------------------------------------------------------------------------
-- 子客户报价数据
drop table if exists csx_analyse_tmp.csx_analyse_tmp_sub_cus_price_guide_pinlei_analyse; 
create table if not exists csx_analyse_tmp.csx_analyse_tmp_sub_cus_price_guide_pinlei_analyse as 
select 
  la.* 
from 
(select 
...
-- ------------------------------------------------------------------------------------------
-- 子客户一天多次报价数据
drop table if exists csx_analyse_tmp.csx_analyse_tmp_sub_cus_price_guide_more_pinlei_analyse; 
create table if not exists csx_analyse_tmp.csx_analyse_tmp_sub_cus_price_guide_more_pinlei_analyse as 
select 
  ddd4.* 
 from 
  (select 
...
-- ------------------------------------------------------------------------------------------
-- 主客户报价数据
drop table if exists csx_analyse_tmp.csx_analyse_tmp_cus_price_guide_pinlei_analyse; 
create table if not exists csx_analyse_tmp.csx_analyse_tmp_cus_price_guide_pinlei_analyse as 
select 
  a.* 
from 
(select 
...
-- ------------------------------------------------------------------------------------------
-- 主客户一天多次报价数据
drop table if exists csx_analyse_tmp.csx_analyse_tmp_cus_price_guide_more_pinlei_analyse; 
create table if not exists csx_analyse_tmp.csx_analyse_tmp_cus_price_guide_more_pinlei_analyse as 
select 
  ddd4.* 
 from 
  (select 
...
-- -------------------------------------------------------------------------------
-- ------生成报价监控相应底表数据
drop table if exists csx_analyse_tmp.csx_analyse_tmp_cus_price_guide_order_pinlei_analyse; 
create table if not exists csx_analyse_tmp.csx_analyse_tmp_cus_price_guide_order_pinlei_analyse as 
select 
  a.order_date,
...
from 
  ...
  -- 子客户报价相关数据
  (select * 
  from csx_analyse_tmp.csx_analyse_tmp_sub_cus_price_guide_pinlei_analyse 
  where num=1) e1 
  ...
  left join
  -- 子客户一天有多次报价的数据处理
  csx_analyse_tmp.csx_analyse_tmp_sub_cus_price_guide_more_pinlei_analyse e2 
  ...
  -- 主客户报价相关数据
  (select * 
  from csx_analyse_tmp.csx_analyse_tmp_cus_price_guide_pinlei_analyse 
  where num=1) e3  
  ...
  left join
  -- 主客户一天有多次报价的数据处理
  csx_analyse_tmp.csx_analyse_tmp_cus_price_guide_more_pinlei_analyse e4 
...
-- ---------------------------------------------------
-- --生成最终明细底表(明秀)
drop table if exists csx_analyse_tmp.csx_analyse_tmp_cus_price_guide_order_final_pinlei_analyse; 
create table if not exists csx_analyse_tmp.csx_analyse_tmp_cus_price_guide_order_final_pinlei_analyse as 
select 
  a.order_date,
  a.require_delivery_date,
  a.final_qj_date,
...
from 
csx_analyse_tmp.csx_analyse_tmp_cus_price_guide_order_pinlei_analyse a 
left join -- 是否是运营
...
drop table if exists csx_analyse_tmp.csx_analyse_tmp_cus_price_guide_order_final_supple_pinlei_analyse; 
create table if not exists csx_analyse_tmp.csx_analyse_tmp_cus_price_guide_order_final_supple_pinlei_analyse as 

select 
  a.*,
  b.shop_price 
from 
csx_analyse_tmp.csx_analyse_tmp_cus_price_guide_order_final_pinlei_analyse a 
left join 
-- 关联北京永辉工厂价
(select 
        b2.sdt,
...
select 
    ...
    sum(profit) as `毛利额`,
    sum(sale_qty) as `销量`  
from csx_analyse_tmp.csx_analyse_tmp_cus_price_guide_order_final_supple_pinlei_analyse 
group by 
...
-- ---------------------------------------------------
-- --生成最终汇总表（调整版，和明秀对完逻辑的数据）
drop table if exists csx_analyse_tmp.csx_analyse_tmp_cus_price_guide_order_final_supple_pinlei_analyse_final;
create table csx_analyse_tmp.csx_analyse_tmp_cus_price_guide_order_final_supple_pinlei_analyse_final
as
select 
    performance_region_name,
    performance_province_name,
    ...
    (case when sec_price_type='全对标' then '对标对象' 
          ...
          when price_source='指定成交价' then price_type 
          when price_source='库存地点售价' then '建议售价' 
     else '其他报价方式' end) as price_source_name,
      price_type,
