...
as
select
	a.cust_flag,a.quarter_of_year,a.business_sign_month,a.business_number,a.customer_id,a.customer_code,a.customer_name,a.first_category_name,a.second_category_name,a.third_category_name,
	...
	a.contract_cycle_desc,a.estimate_contract_amount,a.business_sign_date,a.business_sign_date_2,a.first_business_sign_date,
...
from
	...
	from 
		...
		where 
			...
			and to_date(business_sign_time) between '2022-01-01' and '2023-06-30'
