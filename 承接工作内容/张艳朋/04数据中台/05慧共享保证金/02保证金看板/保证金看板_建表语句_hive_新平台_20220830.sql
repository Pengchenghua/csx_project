drop table if exists csx_analyse.csx_analyse_report_sss_incidental_write_off_detail_di;
create table csx_analyse.csx_analyse_report_sss_incidental_write_off_detail_di(
