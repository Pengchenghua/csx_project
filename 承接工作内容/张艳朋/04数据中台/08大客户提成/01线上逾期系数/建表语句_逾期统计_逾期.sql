...
alter table report_sss_r_m_crm_customer_over_rate_detail add (
...
-- csx_crm_report
delete from csx_crm_report.report_sss_r_m_crm_customer_over_rate_detail  where sdt>=substr(replace(date_sub(curdate(),interval 1 day ),'-',''),1,6);
-- csx_data_market
delete from csx_data_market.report_sss_r_m_crm_customer_over_rate_detail  where sdt>=substr(replace(date_sub(curdate(),interval 1 day ),'-',''),1,6);