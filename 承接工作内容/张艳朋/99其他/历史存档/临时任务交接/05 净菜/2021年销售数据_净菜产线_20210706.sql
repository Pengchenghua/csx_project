...
--今年第一天，本月第一天
set i_sdate_1 ='20210101';	
set i_sdate_2 =regexp_replace(add_months(trunc(date_sub(current_date,1),'MM'),-0),'-','');	
...
from
	...
	from
		...
		where 
			...
			and sdt < ${hiveconf:i_sdate_2}  --'20210701'
