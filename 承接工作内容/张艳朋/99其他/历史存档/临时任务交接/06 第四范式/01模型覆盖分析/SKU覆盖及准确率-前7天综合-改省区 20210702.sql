...
--四川省-W0A6，福建省-W0A8，安徽省-W0A2，北京市-W0A3，重庆-W0A7
...
,stock_vs_previous_rate
from
(select * from csx_ods.pred_table where sdt>=${hiveconf:date_7before} and sdt<=${hiveconf:date_current} and dc_code='W0A6')a
--商品维表
left outer join 
  (
    select *
