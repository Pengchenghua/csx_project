...
from 
  ...
  (
    ...
    where header_status in (3,4)  --3入库中4已完成
	  and ((sdt >= '20210401' and sdt <= '20210901')
      or (sdt = '19990101' and substr(order_time,1,10) >= '20210401' 
  	  and substr(order_time,1,10) <= '20210901'))
...
--采购入库异常标签表  
left join 
  (select * from csx_dw.dws_dsfs_r_d_goods_received_d where scm_sdt>='20210401'
...
from csx_dw.dws_dsfs_r_d_received_batch_detail_abnormal_label
where sdt>='20210801'
and sdt<='20210808'
