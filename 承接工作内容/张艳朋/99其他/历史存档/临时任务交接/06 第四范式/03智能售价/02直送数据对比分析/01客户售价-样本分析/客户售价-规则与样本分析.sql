...
select concat_ws('-',province_name,second_category_code,third_category_code,goods_code) as id,
  region_name,province_name,second_category_code,third_category_code,goods_code,sales_price,cnt
from 
(
  select 
  ...
  (
    ...
    and (return_flag<>'X' or return_flag is null)
...
select concat_ws('-',province_name,second_category_code,goods_code) as id,
  region_name,province_name,second_category_code,goods_code,sales_price,cnt
from 
(
  select 
...
left join csx_tmp.tmp_third_category_sales_price_percentile d 
  on d.province_name=a.province_name and d.third_category_code=a.third_category_code and d.goods_code=a.goods_code
;
...
select a.region_name,a.province_name,
  a.third_category_code,a.third_category_name,
  count(distinct a.customer_no) count_cust,
  sum(a.sales_value) sales_value,
  sum(a.profit) profit,
  sum(a.front_profit) front_profit,
...
--  on c.province_name=a.province_name and c.second_category_code=a.second_category_code and c.goods_code=a.goods_code
left join csx_tmp.tmp_third_category_sales_price_percentile d 
  on d.province_name=a.province_name and d.third_category_code=a.second_category_code and d.goods_code=a.goods_code
group by a.region_name,a.province_name,
a.third_category_code,a.third_category_name
;
