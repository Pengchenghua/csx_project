-- 统计日期
-- source_type not in (2,3,4,11,15,16) 
...
drop table csx_tmp.tmp_dws_dsfs_r_d_goods_received_d;
create temporary table csx_tmp.tmp_dws_dsfs_r_d_goods_received_d
  as
select 
  aa.source_type,
  super_class,
...
--结果表1标签1
insert overwrite  table csx_dw.dws_dsfs_r_d_goods_received_d partition(scm_sdt)
select 
  a.source_type,
  a.super_class,
  a.order_code,
  a.DC_province_code,
  a.DC_province_name,
  a.DC_city_group_code,
  a.DC_city_group_name,
  a.DC_DC_code,
  a.DC_DC_name,
  a.goods_code,
  a.goods_name,
...
( 
  ...
  from csx_tmp.tmp_dws_dsfs_r_d_goods_received_d 
