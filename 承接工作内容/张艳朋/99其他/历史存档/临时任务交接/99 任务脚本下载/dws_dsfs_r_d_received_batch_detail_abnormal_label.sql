...
set last_14day=regexp_replace(date_sub(current_date,15),'-','');
...
(
  ...
  from 
  (select * from csx_tmp.tmp_dws_dsfs_r_d_received_batch_detail_abnormal_label_3 where sdt_end=${hiveconf:current_day}) a 
