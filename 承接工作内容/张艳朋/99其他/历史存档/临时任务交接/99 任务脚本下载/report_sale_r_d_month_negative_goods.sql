...
-- 切换tez计算引擎
set mapred.job.name=report_sale_r_d_month_negative_goods;
...
-- 目标表
set target_table = csx_dw.report_sale_r_d_month_negative_goods;
...
select
  -- 唯一主键
  concat_ws('&', '2', province_code, goods_code, ${hiveconf:current_day}) as id,
   -- 省区范围标识
