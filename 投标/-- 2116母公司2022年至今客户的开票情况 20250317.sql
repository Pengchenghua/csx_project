...
select
       ...
       sum(a.invoice_amount) invoice_amount,
        ...
        sum(case when  then a.invoice_amount end) rp_invoice_amount,
        sum(case when  and substr(a.happen_date,1,4)=2022 then a.invoice_amount end) rp_invoice_amount_2022,
        sum(case when  and substr(a.happen_date,1,4)=2023 then a.invoice_amount end) rp_invoice_amount_2023,
        sum(case when  and substr(a.happen_date,1,4)=2024 then a.invoice_amount end) rp_invoice_amount_2024,
        sum(case when  and substr(a.happen_date,1,4)=2025 then a.invoice_amount end) rp_invoice_amount_2025 
from 
(
        select 
