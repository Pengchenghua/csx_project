...
bid_tender_agency 招标代理机构
win_bid_service_cost 中标服务费
...
regexp_replace(regexp_replace(bid_tender_agency,'\n',''),'\r','') as bid_tender_agency,	 -- 招标代理机构
bid_amount,
bid_package_max,
bid_amount_max,
supply_deadline,
