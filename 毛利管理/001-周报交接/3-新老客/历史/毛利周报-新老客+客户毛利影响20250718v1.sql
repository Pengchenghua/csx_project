...
select
	...
	city_group_name,
	xinlaok_original,	
	count(distinct case when sdt>='20250701' and sdt<='20250731' then customer_code end) sy_cust,
	count(distinct case when sdt>='20250801' and sdt<='20250831' then customer_code end) by_cust,	
	
	sum(case when sdt>='20250701' and sdt<='20250731' then sale_amt end)/10000 as sy_sale_amt,
	sum(case when sdt>='20250701' and sdt<='20250731' then profit end)/10000 as sy_profit,
	
	sum(case when sdt>='20250801' and sdt<='20250831' then sale_amt end)/10000 as by_sale_amt,
	sum(case when sdt>='20250801' and sdt<='20250831' then profit end)/10000 as by_profit,
	
	sum(case when sdt>='20250726' and sdt<='20250801' then sale_amt end)/10000 w1_sale_amt,
	sum(case when sdt>='20250726' and sdt<='20250801' then profit end)/10000 w1_profit,
	
	sum(case when sdt>='20250802' and sdt<='20250808' then sale_amt end)/10000 w2_sale_amt,
	sum(case when sdt>='20250802' and sdt<='20250808' then profit end)/10000 w2_profit,

	sum(case when sdt>='20250809' and sdt<='20250815' then sale_amt end)/10000 w3_sale_amt,
	sum(case when sdt>='20250809' and sdt<='20250815' then profit end)/10000 w3_profit,
	
	sum(case when sdt>='20250816' and sdt<='20250822' then sale_amt end)/10000 w4_sale_amt,
	sum(case when sdt>='20250816' and sdt<='20250822' then profit end)/10000 w4_profit,

	sum(case when sdt>='20250823' and sdt<='20250829' then sale_amt end)/10000 w5_sale_amt,
	sum(case when sdt>='20250823' and sdt<='20250829' then profit end)/10000 w5_profit		
...
select
	...
	sum(case when sdt>='20250701' and sdt<='20250731' then sale_amt end)/10000 as sy_sale_amt,
	sum(case when sdt>='20250701' and sdt<='20250731' then profit end)/10000 as sy_profit,
	sum(case when sdt>='20250701' and sdt<='20250731' then profit end)/abs(sum(case when sdt>='20250701' and sdt<='20250731' then sale_amt end)) sy_profit_rate,	
		
	sum(case when sdt>='20250801' and sdt<='20250831' then sale_amt end)/10000 as by_sale_amt,
	sum(case when sdt>='20250801' and sdt<='20250831' then profit end)/10000 as by_profit,
	sum(case when sdt>='20250801' and sdt<='20250831' then profit end)/abs(sum(case when sdt>='20250801' and sdt<='20250831' then sale_amt end)) by_profit_rate,
	
	sum(case when sdt>='20250801' and sdt<='20250831' then profit end)/abs(sum(case when sdt>='20250801' and sdt<='20250831' then sale_amt end))-sum(case when sdt>='20250701' and sdt<='20250731' then profit end)/abs(sum(case when sdt>='20250701' and sdt<='20250731' then sale_amt end)) as diff_profit_rate,

	
	sum(case when sdt>='20250726' and sdt<='20250801' then profit end)/abs(sum(case when sdt>='20250726' and sdt<='20250801' then sale_amt end)) w1_profit_rate,	
	sum(case when sdt>='20250802' and sdt<='20250808' then profit end)/abs(sum(case when sdt>='20250802' and sdt<='20250808' then sale_amt end)) w2_profit_rate,
	sum(case when sdt>='20250809' and sdt<='20250815' then profit end)/abs(sum(case when sdt>='20250809' and sdt<='20250815' then sale_amt end)) w3_profit_rate,
	sum(case when sdt>='20250816' and sdt<='20250822' then profit end)/abs(sum(case when sdt>='20250816' and sdt<='20250822' then sale_amt end)) w4_profit_rate,
	sum(case when sdt>='20250823' and sdt<='20250829' then profit end)/abs(sum(case when sdt>='20250823' and sdt<='20250829' then sale_amt end)) w5_profit_rate
...
&token=eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiIxZDRhOGYwMjUyZmQ0ZjA2OTU2OTBhNjlhYTQ2M2U5YSIsInVzZXJJZCI6IjEwMDAwMDA1NTcxNjkiLCJ1c2VyTmFtZSI6IumltuiJs-WNjiIsImlhdCI6MTc2MTkwMDg0MywiZXhwIjoxNzYxOTA0NDQzfQ.3vENc9rklCu_2ahNC_68ofl_sUpNaFnNiKseGQBhjUw
