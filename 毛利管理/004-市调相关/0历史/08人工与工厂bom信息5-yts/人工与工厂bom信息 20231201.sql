...
select 
	...
	a.goods_type_name,
	a.product_code ,
	if(a.product_name='',e.product_name,regexp_replace(regexp_replace(a.product_name,'\n',''),'\r','')) as product_name,
	if(a.product_unit='',e.unit,a.product_unit) as product_unit,
	if(a.product_spec='',e.spec,a.product_spec) as product_spec,	-- 规格	
	a.product_num,
	a.scrap_rate,
