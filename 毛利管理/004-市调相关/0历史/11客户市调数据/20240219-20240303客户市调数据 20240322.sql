...
drop table if exists csx_analyse_tmp.price_market_customer_research_price_effective_di; 
create table if not exists csx_analyse_tmp.price_market_customer_research_price_effective_di as 
select
	...
	when a.source=6 then '系统爬取'	
	else a.source end as source, -- 来源: 0:市调导入；1:小程序;2:小程序-pc端 3: 线上网站市调 4:通用市调系统生成 5:市调图片导入',6:系统爬取
	-- a.status,  -- 状态(1有效 0无效)
...
from 
	...
	from 
		...
		and sdt<='20240909'
		and status=1
		and customer_code in ('107592','195996','190538','248263')
		-- and customer_code='245559'
