...
select 
	...
	sum(case when is_market_research_price_ty_online='是' then sale_amt end)/10000 as sd_sale_amt_ty_online,
	sum(case when is_market_research_price_ty_offline='是' then sale_amt end)/10000 as sd_sale_amt_ty_offline	
from csx_analyse.csx_analyse_price_market_research_cover_rate_nqd_wi
-- from csx_analyse_tmp.csx_analyse_price_market_research_cover_rate_nqd_wi
where swt='${EDATE}'
