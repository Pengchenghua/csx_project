...
-- drop table csx_analyse_tmp.csx_analyse_fr_tc_customer_credit_order_detail;
...
drop table csx_analyse_tmp.tmp_tc_business_billmonth_profit_rate_tc;
...
select *,
	...
	case when bbc_ly_profit_rate<0.03 then 0.002
		...
		when bbc_ly_profit_rate>=0.17 then 0.0115
	...
	case when fl_profit_rate<0.03 then 0.002
		...
		when fl_profit_rate>=0.17 then 0.0115
...
-- drop table csx_analyse_tmp.csx_analyse_fr_tc_customer_bill_month_dff_rate_detail;
...
select 
	...
	((rp_pay_amt*cust_rp_profit_rate_tc*dff_rate*rp_sales_fp_rate)+
