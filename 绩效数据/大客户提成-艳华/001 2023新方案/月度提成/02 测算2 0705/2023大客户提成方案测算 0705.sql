...
select 
	...
	rp_profit,
	bbc_profit,
	bbc_ly_profit*1.2 as bbc_ly_profit,
	bbc_zy_profit,
	fl_profit*1.2 as fl_profit
from 
	(
	select 
...
select *,
	...
	coalesce(profit_target_rate,1) as profit_target_rate_tc			
from 
(
	select 
...
select 
	...
	rp_pay_amt*cust_rp_profit_rate_tc*dff_rate*rp_service_user_fp_rate*coalesce(e.new_cust_rate,1)*d2.profit_target_rate_tc as tc_rp_service,		
