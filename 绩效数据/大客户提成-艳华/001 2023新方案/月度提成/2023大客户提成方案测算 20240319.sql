...
select *,
	case 
		...
		when a.work_no in('80894299','80981355') and substr(regexp_replace(last_day(add_months('${sdt_yes_date}',-1)),'-',''),1,6) between '202309' and '202408' then profit_target_rate
		when a.work_no in('80948173') and substr(regexp_replace(last_day(add_months('${sdt_yes_date}',-1)),'-',''),1,6) between '202311' and '202410' then profit_target_rate
		when a.work_no in('81225749') and substr(regexp_replace(last_day(add_months('${sdt_yes_date}',-1)),'-',''),1,6) between '202401' and '202412' then profit_target_rate
