/*
1、签呈任务需要重点下游，客户对应销售员与服务管家及提成系数_签呈版 csx_analyse_customer_sale_service_info_rate_qc_mi 
2、涉及到福利&BBC系数*1.2表
...
select 
	...
	case 
		 ...
		 when a.province_code='13' and sdt>='20240501' and a.sales_id_new <>'' then 1
	...
	case when  a.province_code in ('13','23','24','32','11','1','26','19','14','20','906') then b1.level_sale_rate*2
		else b1.level_sale_rate  end as rp_service_user_fp_rate,
	case when a.province_code='13' and sdt>='20240501' then 0 
		when a.province_code in ('23','24','32','11','1','26','19','14','20','906') then b2.level_sale_rate*2
		else b2.level_sale_rate end as fl_service_user_fp_rate,
	case when a.province_code='13' and sdt>='20240501' then 0 
		when  a.province_code in ('23','24','32','11','1','26','19','14','20','906') then b3.level_sale_rate*2
