...
from csx_analyse.csx_analyse_report_crm_customer_sale_service_manager_info_df
where sdt='20240930' 
	and customer_no in ('117416','128077','250029','250230','107717','107657','123235','124573','124591',
		'119317','223523','112624','113720','130053','107567','113461','202792','250948','122012','128485',
		'121082','252183','252191','252193','252181','151497','252182','252185','252186','252189','252195',
		'120513','123477','237014','154936','127287','174570','156308','164594','175193','184724','194499',
		'119765','216783','117911','118670','125989','119531','122487','228848','166342','122479','121870',
		'225346','225268','129207','173084','174886','127736','252139','105165','118825','120742','105164',
		'204435','203631','126501','226019','226028','226030','226039'
		)
)a 
-- 关联管家等级	
left join
...
case when  a.province_code in ('23','24','32','14','20','906') then b1.level_sale_rate*2
		when a.province_code in ('13') and (a.work_no_new ='' or sales_name_new like '%B') then b1.level_sale_rate*2
		when a.province_code in ('11') and a.work_no_new ='' then 0.4
		else b1.level_sale_rate  end as  rp_service_user_fp_rate,
null rp_service_user_profit_rate,
	case 
		when a.province_code in ('23','24','32','14','20','906') then b2.level_sale_rate*2
		when a.province_code in ('13') and (a.work_no_new ='' or sales_name_new like '%B') then b2.level_sale_rate*2
		when a.province_code in ('11') and a.work_no_new ='' then 0.4
		else b2.level_sale_rate end as  fl_service_user_fp_rate,
null fl_service_user_profit_rate,
	case 
		when  a.province_code in ('23','24','32','14','20','906') then b3.level_sale_rate*2
		when a.province_code in ('13') and (a.work_no_new ='' or sales_name_new like '%B') then b3.level_sale_rate*2
		when a.province_code in ('11') and a.work_no_new ='' then 0.4
		else b3.level_sale_rate end as bbc_service_user_fp_rate,
...
from csx_analyse.csx_analyse_report_crm_customer_sale_service_manager_info_df 
where sdt='20241031'
and customer_code in ('249734','121173')
)a 
-- 关联管家等级	
left join
(
