...
-- case when a.province_name='浙江省' and sdt>='20240501' then 0 else b3.level_sale_rate end as bbc_service_user_fp_rate ,
	case when  a.province_code in ('14','20','906','1') then b1.level_sale_rate*2
		when a.province_code in ('23','24','32','13') and (a.work_no_new ='' or sales_name_new like '%B') then b1.level_sale_rate*2
	...
	-- when a.province_code='13' and sdt>='20240501' then 0 
		when a.province_code in ('14','20','906','1') then b2.level_sale_rate*2
		when a.province_code in ('23','24','32','13') and (a.work_no_new ='' or sales_name_new like '%B') then b2.level_sale_rate*2
		when a.province_code in ('11') and a.work_no_new ='' then 0.4
		else b2.level_sale_rate end as fl_service_user_fp_rate,
	case 
	-- when a.province_code='13' and sdt>='20240501' then 0 
		when  a.province_code in ('14','20','906','1') then b3.level_sale_rate*2
		when a.province_code in ('23','24','32','13') and (a.work_no_new ='' or sales_name_new like '%B') then b3.level_sale_rate*2
		when a.province_code in ('11') and a.work_no_new ='' then 0.4
