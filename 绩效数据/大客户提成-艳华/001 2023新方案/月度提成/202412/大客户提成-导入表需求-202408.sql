...
tc_customer_special_rules_2023
 INSERT	into csx_data_config.tc_customer_special_rules_2023
	...
	data_source)
SELECT	
	CONCAT('2024010', '_', customer_code) biz_id,
	province_name,
	customer_code,
	'202410' smt_date,
	qc_yearmonth,
...
where
	...
	and (effective_period != '当月'
		and effective_period not like '%202411'
	)
...
-- 华西12月按照新方案，注意：未挂靠销售员的，按照服务管家新系数*200%
...
(biz_id,
	...
	smt_date)
SELECT
	concat('202412','_',customer_no )biz_id,
	customer_id,
	customer_no,
	customer_name,
	channel_code,
	...
	case when  province_code in ('32','24','23') then rp_service_user_sale_fp_rate*2 
		else rp_service_user_sale_fp_rate 
	end  rp_service_user_sale_fp_rate,
	rp_service_user_profit_fp_rate,
	case when  province_code in ('32','24','23') then fl_service_user_sale_fp_rate*2 else 
		 fl_service_user_sale_fp_rate
		end fl_service_user_sale_fp_rate,
	fl_service_user_profit_fp_rate,
	case when  province_code in ('32','24','23') then  bbc_service_user_sale_fp_rate*2 
	else bbc_service_user_sale_fp_rate
	end bbc_service_user_sale_fp_rate,
	bbc_service_user_profit_fp_rate,
	'202412' smt_date 
-- 	b.category_first,
-- 	effective_period 
...
(biz_id,
	...
	smt_date)
SELECT
	concat('202411','_',customer_no )biz_id,
	customer_id,
	customer_no,
	customer_name,
	channel_code,
