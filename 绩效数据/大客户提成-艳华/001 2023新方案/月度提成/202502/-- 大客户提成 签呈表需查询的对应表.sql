...
-- 华西延迟一个月202412 '23','24','32',
	case when  a.province_code in ('23','24','32','1') then b1.level_sale_rate*2
	...
	-- when a.province_code='13' and sdt>='20240501' then 0 
		when a.province_code in ('23','24','32','1') then b2.level_sale_rate*2
	...
	case 
	-- when a.province_code='13' and sdt>='20240501' then 0 
		when  a.province_code in ('23','24','32','1') then b3.level_sale_rate*2
