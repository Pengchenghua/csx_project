...
tc_customer_special_rules_2023
 INSERT	into csx_data_config.tc_customer_special_rules_2023
	...
	data_source)
SELECT	
	CONCAT('202504', '_', customer_code) biz_id,
	province_name,
	customer_code,
	'202504' smt_date,
	qc_yearmonth,
...
where
	...
	and (effective_period != '当月'
		and effective_period not like '%202503'
	)
...
(biz_id,
	...
	smt_date)
SELECT
	concat('202501','_',customer_no )biz_id,
	customer_id,
	customer_no,
	customer_name,
	channel_code,
	...
	case when  province_code in ('14','906','20') then rp_service_user_sale_fp_rate*0.5
		else rp_service_user_sale_fp_rate 
	end  rp_service_user_sale_fp_rate,
	rp_service_user_profit_fp_rate,
	case when  province_code in ('14','906','20') then fl_service_user_sale_fp_rate*0.5
	else 
		 fl_service_user_sale_fp_rate
		end fl_service_user_sale_fp_rate,
	fl_service_user_profit_fp_rate,
	case when  province_code in ('14','906','20') then  bbc_service_user_sale_fp_rate*0.5 
...
(biz_id,
	...
	smt_date)
SELECT
	concat('202504','_',customer_no )biz_id,
	customer_id,
	customer_no,
	customer_name,
	channel_code,
