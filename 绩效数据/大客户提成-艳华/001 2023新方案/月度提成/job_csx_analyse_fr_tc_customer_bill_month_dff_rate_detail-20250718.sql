-- ******************************************************************** 
-- @功能描述：job_csx_analyse_fr_tc_customer_bill_month_dff_rate_detail
-- @创建者： 饶艳华 
...
WITH base_data AS (
    SELECT 
        ...
        CASE 
            ...
            WHEN j.renew_flag = '1' AND a.happen_month >= '202504' THEN j.renew_cust_rate
    ...
    LEFT JOIN (
        SELECT customer_code, 0.8 AS renew_cust_rate, '1' AS renew_flag 
