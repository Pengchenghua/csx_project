...
-- 表2 csx_analyse_fr_tc_customer_credit_order_unpay_mi 大客户提成-核销订单的待核销金额-----------不含BBC纯现金客户---------------------------
...
-- 表3 csx_analyse_fr_tc_customer_credit_order_detail 大客户提成-回款订单明细--------------------------------------
...
-- 表4 csx_analyse_fr_tc_customer_person_profit_real_mi 大客户提成-客户人员毛利完成值--------------------------------------
...
-- 表5 csx_analyse_tc_person_profit_target_rate 大客户提成-人员毛利目标达成情况--------------------------------------
...
and (a.profit+a.profit_basic)<>0;



-- 表6 csx_analyse_fr_tc_customer_bill_month_dff_rate_detail 大客户提成-客户结算月回款时间系数明细--------------------------------------
