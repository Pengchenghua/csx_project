...
select 
	...
	a.work_no,
	a.sales_name,
	a.sort_array(array(b1.profit_target_rate,b2.profit_target_rate,b3.profit_target_rate,b4.profit_target_rate)) as arr
...
rp_service_user_work_no,
	...
	if(d1.profit_target_rate_tc=1 and a.sales_target_rate_tc=0 
	and d1.begin_less_1year_flag='否' 
	and (a.province_name='湖北省' or a.province_name<>'湖北省' and a.smt>='202311'),
	(
	if(a.paid_date<=last_day(add_months(date_format(from_unixtime(unix_timestamp(concat(a.smt,'01'),'yyyyMMdd')), 'yyyy-MM-dd'),-2)) 
	and coalesce(e1.account_period_name,'0')<>'预付货款' 
	and b1.category_second is null 
	and b3.category_second is null 
	and b2.category_second is null,0,
...
rp_service_profit_basic_new,
rp_service_profit_new,
rp_service_profit_target_rate_new,
rp_service_profit_target_rate_tc_new,
fl_service_profit_basic_new,
fl_service_profit_new,
fl_service_profit_target_rate_new,
fl_service_profit_target_rate_tc_new,
bbc_service_profit_basic_new,
bbc_service_profit_new,
bbc_service_profit_target_rate_new,
bbc_service_profit_target_rate_tc_new,
tc_sales_new,
tc_rp_service_new,
tc_fl_service_new,
tc_bbc_service_new,

tc_sales_new-tc_sales as tc_sales_cy,
tc_rp_service_new-tc_rp_service as tc_rp_service_cy,
tc_fl_service_new-tc_fl_service as tc_fl_service_cy,
tc_bbc_service_new-tc_bbc_service as tc_bbc_service_cy
from csx_analyse_tmp.tmp_tc_customer_bill_month_dff_rate_detail_year_b
where province_name like'%上海%';
