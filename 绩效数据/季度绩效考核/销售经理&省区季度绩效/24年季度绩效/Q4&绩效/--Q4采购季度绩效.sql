...
(
 select 
   ...
   performance_province_name,
   dc_code,
    case when classify_middle_name in ('调理预制品','猪肉','家禽','水果','蔬菜','水产','牛羊') then classify_middle_name
...
--  IF(performance_province_name='浙江省',concat(performance_province_name,performance_city_name),performance_province_name) performance_province_name,
 ...
 select
  ...
  performance_city_name,
  business_type_name,
    if(a.classify_middle_name in ('水果','蔬菜','水产','牛羊','调理预制品','猪肉','家禽','米','蛋','熟食烘焙','干货'),'生鲜','食百') as  dept_name,
