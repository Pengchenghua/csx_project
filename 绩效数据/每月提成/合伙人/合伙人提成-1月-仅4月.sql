...
create temporary table csx_tmp.temp_partner_cust_01
as
select a.smonth,
	...
	round(sum(a.sales_value)*0.002,2) salery_cal,
...
select a.*,
	b.paid_amount,b.residual_amount,e.residual_amount residual_amount_all,
