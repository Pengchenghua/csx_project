...
with tmp_study_fm_user_form_data as (
  ...
  WHERE
    b.is_delete = 0
    and a.create_time<'2025-02-17 00:00:00'   -- 次月需要限制创建日期
    and a.create_time>='2025-02-01 00:00:00 '
...
from dev.csx_analyse_fr_hr_customer_evaluation_detail_mf
where smt='202502'
...
(  
    ...
    (select customer_code
    from  csx_dws.csx_dws_sale_detail_di 
        where sdt>='20250101' and sdt<='20250131'
...
tmp_study_fm_user_form_data as (
  ...
  WHERE
    b.is_delete = 0
    and a.create_time<'2025-02-17 00:00:00'
    and a.create_time>='2025-02-01 00:00:00'
   -- AND a.form_key = 'Gznp3ieG'
),
tmp_study_fm_user_form_data_clean as (
...
(  
    ...
    (select customer_code
    from  csx_dws.csx_dws_sale_detail_di 
        where sdt>='20240601' and sdt<='20250131'
    group by customer_code ) b on a.customer_code=b.customer_code
    where sdt = '20250131'  
        and business_attribute_code in ('1','2','5')
