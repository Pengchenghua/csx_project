...
select
	...
	case when substr(b_bbc_first_order_date,1,4) <='2019' then '19年及之前新客'
		...
		when substr(b_bbc_first_order_date,1,4)='2024' then '24年新客'
		else '其他'
	...
	case when substr(rp_first_order_date,1,4) <='2019' then '19年及之前新客'
		...
		when substr(rp_first_order_date,1,4)='2024' then '24年新客'
		else '其他'
...
select
	...
	--23年新客
	count(distinct case when b.b_bbc_customer_type='23年新客' and f.customer_code is not null and g.customer_code is null then a.customer_code end) as `23年履约且24年未履约的23年新客户客户数`,
	count(distinct case when b.b_bbc_customer_type='23年新客' and f.customer_code is not null and g.customer_code is not null then a.customer_code end) as `23年履约的24年新客户客户数`,
	sum(case when b.b_bbc_customer_type='23年新客' and f.customer_code is not null and g.customer_code is null then a.sale_amt end) as `23年履约且24年未履约的23年新客户含税收入`,
	sum(case when b.b_bbc_customer_type='23年新客' and f.customer_code is not null and g.customer_code is not null then a.sale_amt end) as `23年履约的24年新客户含税收入`, 
	
	sum(case when b.b_bbc_customer_type='23年新客' and f.customer_code is not null and g.customer_code is null then a.profit_no_tax end)/
	abs(sum(case when b.b_bbc_customer_type='23年新客' and f.customer_code is not null and g.customer_code is null then a.sale_amt_no_tax end)) as `2年履约且24年未履约的23年新客户不含税毛利率`,

	sum(case when b.b_bbc_customer_type='23年新客' and f.customer_code is not null and g.customer_code is not null then a.profit_no_tax end)/
	abs(sum(case when b.b_bbc_customer_type='23年新客' and f.customer_code is not null and g.customer_code is not null then a.sale_amt_no_tax end)) as `23年履约的24年新客户不含税毛利率`,	
	
	sum(case when b.b_bbc_customer_type='23年新客' and f.customer_code is not null and g.customer_code is null then a.profit_no_tax end) as `23年履约且23年未履约的24年新客户不含税毛利额`,
	sum(case when b.b_bbc_customer_type='23年新客' and f.customer_code is not null and g.customer_code is null then a.sale_amt_no_tax end) as `23年履约且23年未履约的24年新客户不含税销售额`,
	
	sum(case when b.b_bbc_customer_type='23年新客' and f.customer_code is not null and g.customer_code is not null then a.profit_no_tax end) as `23年履约的24年新客户不含税毛利额`,
	sum(case when b.b_bbc_customer_type='23年新客' and f.customer_code is not null and g.customer_code is not null then a.sale_amt_no_tax end) as `23年履约的24年新客户不含税销售额`,
	--24年新客
	count(distinct case when b.b_bbc_customer_type='24年新客' and g.customer_code is not null then a.customer_code end) as `24年履约的24年新客户客户数`,
	sum(case when b.b_bbc_customer_type='24年新客' and g.customer_code is not null then a.sale_amt end) as `24年履约的24年新客户含税收入`,
	
	sum(case when b.b_bbc_customer_type='24年新客' and g.customer_code is not null then a.profit_no_tax end)/
	abs(sum(case when b.b_bbc_customer_type='24年新客' and g.customer_code is not null then a.sale_amt_no_tax end)) as `24年履约的24年新客户不含税毛利率`,	
	
	sum(case when b.b_bbc_customer_type='24年新客' and g.customer_code is not null then a.profit_no_tax end) as `24年履约的24年新客户不含税毛利额`,
	sum(case when b.b_bbc_customer_type='24年新客' and g.customer_code is not null then a.sale_amt_no_tax end) as `24年履约的24年新客户不含税销售额`
from
	(-- 履约
	select
...
select
	...
	--23年新客
	count(distinct case when b.rp_customer_type='23年新客' and f.customer_code is not null and g.customer_code is null then a.customer_code end) as `22年履约且23年未履约的23年新客户客户数`,
	count(distinct case when b.rp_customer_type='23年新客' and f.customer_code is not null and g.customer_code is not null then a.customer_code end) as `23年履约的23年新客户客户数`,
	sum(case when b.rp_customer_type='23年新客' and f.customer_code is not null and g.customer_code is null then a.sale_amt end) as `22年履约且23年未履约的23年新客户含税收入`,
	sum(case when b.rp_customer_type='23年新客' and f.customer_code is not null and g.customer_code is not null then a.sale_amt end) as `23年履约的23年新客户含税收入`, 
	
	sum(case when b.rp_customer_type='23年新客' and f.customer_code is not null and g.customer_code is null then a.profit_no_tax end)/
	abs(sum(case when b.rp_customer_type='23年新客' and f.customer_code is not null and g.customer_code is null then a.sale_amt_no_tax end)) as `22年履约且23年未履约的23年新客户不含税毛利率`,

	sum(case when b.rp_customer_type='23年新客' and f.customer_code is not null and g.customer_code is not null then a.profit_no_tax end)/
	abs(sum(case when b.rp_customer_type='23年新客' and f.customer_code is not null and g.customer_code is not null then a.sale_amt_no_tax end)) as `23年履约的23年新客户不含税毛利率`,	
	
	sum(case when b.rp_customer_type='23年新客' and f.customer_code is not null and g.customer_code is null then a.profit_no_tax end) as `22年履约且23年未履约的23年新客户不含税毛利额`,
	sum(case when b.rp_customer_type='23年新客' and f.customer_code is not null and g.customer_code is null then a.sale_amt_no_tax end) as `22年履约且23年未履约的23年新客户不含税销售额`,
	
	sum(case when b.rp_customer_type='23年新客' and f.customer_code is not null and g.customer_code is not null then a.profit_no_tax end) as `23年履约的23年新客户不含税毛利额`,
	sum(case when b.rp_customer_type='23年新客' and f.customer_code is not null and g.customer_code is not null then a.sale_amt_no_tax end) as `23年履约的23年新客户不含税销售额`,
	--23年新客
	count(distinct case when b.rp_customer_type='24年新客' and g.customer_code is not null then a.customer_code end) as `24年履约的24年新客户客户数`,
	sum(case when b.rp_customer_type='24年新客' and g.customer_code is not null then a.sale_amt end) as `24年履约的24年新客户含税收入`,
	
	sum(case when b.rp_customer_type='24年新客' and g.customer_code is not null then a.profit_no_tax end)/
	abs(sum(case when b.rp_customer_type='24年新客' and g.customer_code is not null then a.sale_amt_no_tax end)) as `23年履约的24年新客户不含税毛利率`,	
	
	sum(case when b.rp_customer_type='24年新客' and g.customer_code is not null then a.profit_no_tax end) as `23年履约的24年新客户不含税毛利额`,
	sum(case when b.rp_customer_type='24年新客' and g.customer_code is not null then a.sale_amt_no_tax end) as `23年履约的24年新客户不含税销售额`
