...
select
	...
	--23年新客
	count(distinct case when b.b_bbc_customer_type='23年新客' and g.customer_code is not null and h.customer_code is null then a.customer_code end) as `23年履约且24年未履约的23年新客户客户数`,
	count(distinct case when b.b_bbc_customer_type='23年新客' and g.customer_code is not null and h.customer_code is not null then a.customer_code end) as `24年履约的23年新客户客户数`,
	sum(case when b.b_bbc_customer_type='23年新客' and g.customer_code is not null and h.customer_code is null then a.sale_amt end) as `23年履约且24年未履约的23年新客户含税收入`,
	sum(case when b.b_bbc_customer_type='23年新客' and g.customer_code is not null and h.customer_code is not null then a.sale_amt end) as `24年履约的23年新客户含税收入`, 
	
	sum(case when b.b_bbc_customer_type='23年新客' and g.customer_code is not null and h.customer_code is null then a.profit_no_tax end)/
	abs(sum(case when b.b_bbc_customer_type='23年新客' and g.customer_code is not null and h.customer_code is null then a.sale_amt_no_tax end)) as `23年履约且24年未履约的23年新客户不含税毛利率`,

	sum(case when b.b_bbc_customer_type='23年新客' and g.customer_code is not null and h.customer_code is not null then a.profit_no_tax end)/
	abs(sum(case when b.b_bbc_customer_type='23年新客' and g.customer_code is not null and h.customer_code is not null then a.sale_amt_no_tax end)) as `24年履约的23年新客户不含税毛利率`,	
	
	sum(case when b.b_bbc_customer_type='23年新客' and g.customer_code is not null and h.customer_code is null then a.profit_no_tax end) as `23年履约且24年未履约的23年新客户不含税毛利额`,
	sum(case when b.b_bbc_customer_type='23年新客' and g.customer_code is not null and h.customer_code is null then a.sale_amt_no_tax end) as `23年履约且24年未履约的23年新客户不含税销售额`,
	
	sum(case when b.b_bbc_customer_type='23年新客' and g.customer_code is not null and h.customer_code is not null then a.profit_no_tax end) as `24年履约的23年新客户不含税毛利额`,
	sum(case when b.b_bbc_customer_type='23年新客' and g.customer_code is not null and h.customer_code is not null then a.sale_amt_no_tax end) as `24年履约的23年新客户不含税销售额`,
	--24年新客
	count(distinct case when b.b_bbc_customer_type='24年新客' and h.customer_code is not null then a.customer_code end) as `24年履约的24年新客户客户数`,
	sum(case when b.b_bbc_customer_type='24年新客' and h.customer_code is not null then a.sale_amt end) as `24年履约的24年新客户含税收入`,
	
	sum(case when b.b_bbc_customer_type='24年新客' and h.customer_code is not null then a.profit_no_tax end)/
	abs(sum(case when b.b_bbc_customer_type='24年新客' and h.customer_code is not null then a.sale_amt_no_tax end)) as `24年履约的24年新客户不含税毛利率`,	
	
	sum(case when b.b_bbc_customer_type='24年新客' and h.customer_code is not null then a.profit_no_tax end) as `24年履约的24年新客户不含税毛利额`,
	sum(case when b.b_bbc_customer_type='24年新客' and h.customer_code is not null then a.sale_amt_no_tax end) as `24年履约的24年新客户不含税销售额`
from
	(-- 履约
	select
	...
	left join --2024年履约
		...
		from
			csx_dws.csx_dws_sale_detail_di
		where 
			sdt>='20240101' and sdt<='20241231'
			and channel_code in('1','7','9')
		group by 
			customer_code,substr(sdt,1,4)
		) h on h.customer_code=a.customer_code
group by 
